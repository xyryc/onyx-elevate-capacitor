...
| :----------------------- | :---------------------------------------- | :----------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------ |
| **Monthly Subscription** | `com.onyxelevate.app.all_access_monthly`  | Auto-renewable Subscription    | Configure **Introductory Offer**: _Pay as you go - 1 period at intro price_ (closest tiered pricing matching $6.99, R$ 14,99, €5,99, 49 kr) |
| **Yearly Subscription**  | `com.onyxelevate.app.all_access_yearly`   | Auto-renewable Subscription    | Configure **Introductory Offer**: _Free trial_ (1-week free trial). Apple-only promo; optionally mirror on Stripe Yearly for web parity.    |
