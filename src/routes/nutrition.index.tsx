  ...
  head: () => ({
    meta: [
      { title: "Nutrition Tracker, Log Meals, AI Food Scan & Macros · Onyx Elevate" },
      {
        name: "description",
        content:
          "The Onyx nutrition tracker: log every meal, snap your plate for AI calorie & macro scanning, hit your goals and track weight. Included with any Onyx membership.",
      },
      {
        property: "og:title",
        content: "Onyx Nutrition, Food diary, AI photo scan & macro tracker",
      },
      {
        property: "og:description",
        content:
          "Log meals, scan your plate with AI, track calories, macros & weight, included with any Onyx membership.",
      },
          ...
          <div className="container-onyx py-3 flex items-center justify-between gap-3 flex-wrap">
            <p className="text-sm">
              <span className="font-semibold text-electric">
                {t("nutrition.gate.memberBanner.title")}
              </span>{" "}
      ...
      <div className="mx-auto w-full max-w-[560px] px-6">
        ...
        <section className="mb-10">
          <div className="flex items-center gap-4 mb-5">
            <span className="text-[10px] font-mono font-bold text-muted-foreground/70 tracking-tighter uppercase italic">
              {t("nutrition.gate.section1Label")}
            </span>
          ...
          <p className="font-display text-xl md:text-2xl font-light italic leading-snug text-foreground/85">
            ...
            <span className="not-italic font-bold text-foreground">
              {t("nutrition.gate.introBrand")}
            </span>
            {t("nutrition.gate.intro2")}
          </p>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-4 mb-6">
            <span className="text-[10px] font-mono font-bold text-muted-foreground/70 tracking-tighter uppercase italic">
              {t("nutrition.gate.section2Label")}
            </span>
            <div className="h-px flex-1 bg-border/40" />
          </div>
