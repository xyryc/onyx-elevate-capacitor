...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Onyx Elevate collects, uses and protects your personal data." },
    ],
  }),
    ...
    <section className="container-onyx py-16 max-w-3xl">
      ...
      <div className="mt-10 space-y-8 text-foreground/85 leading-relaxed">
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1" dangerouslySetInnerHTML={{ __html: t("privacy.s2.body") }} />
        </div>
        <div>
          <h2 className="font-display text-xl font-bold mb-2">{t("privacy.s3.title")}</h2>
          <ul className="list-disc pl-6 space-y-1" dangerouslySetInnerHTML={{ __html: t("privacy.s3.body") }} />
        </div>
        <div>
          <h2 className="font-display text-xl font-bold mb-2">{t("privacy.s4.title")}</h2>
          <p>{t("privacy.s4.intro")}</p>
          <ul className="list-disc pl-6 space-y-1" dangerouslySetInnerHTML={{ __html: t("privacy.s4.body") }} />
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1" dangerouslySetInnerHTML={{ __html: t("privacy.s9.body") }} />
