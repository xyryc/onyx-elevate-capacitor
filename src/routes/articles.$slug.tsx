    ...
    <article>
      ...
      <section className="relative border-b border-border/60">
        ...
        <div className="container-onyx -mt-32 md:-mt-44 relative pb-8">
          <Link to="/" className="text-xs uppercase tracking-[0.2em] text-electric font-semibold">← All articles</Link>
      ...
      <div className="container-onyx py-12 md:py-16 grid lg:grid-cols-3 gap-10 lg:gap-14">
        ...
        <aside className="lg:sticky lg:top-24 h-fit space-y-6">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-electric font-semibold mb-3">More reading</p>
            <div className="space-y-3">
              {related.map((r) => (
                <Link key={r.slug} to="/articles/$slug" params={{ slug: r.slug }}
                  ...
                  <div className="flex gap-3">
                    <div className="relative w-24 flex-none aspect-square overflow-hidden">
                      <img src={r.img} alt="" width={200} height={200} loading="lazy"
                        className="h-full w-full object-cover" decoding="async" />
                    </div>
                    <div className="p-3 pr-3">
                      <p className="text-xs text-electric font-semibold uppercase tracking-wider">{r.category}</p>
                      <p className="mt-1 text-sm font-semibold line-clamp-2 group-hover:text-electric transition-colors">{r.title}</p>
