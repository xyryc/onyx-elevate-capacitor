        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-3 text-sm text-muted-foreground min-h-[1.25rem]">
            {access.loading ? null : hasAllAccess ? (
              ...
              <>
                {t("mealPlans.access.allPlans")} ·{" "}
                <span className="font-semibold text-foreground">{mealPrice}</span>{" "}
                {t("mealPlans.access.oneTime")} · {t("mealPlans.access.freePreview")}
              </>
            )}
          </div>
        </div>
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-[11px]">
                      ...
                      <span className="inline-flex items-center gap-1 rounded-md border border-border/60 bg-onyx-50/60 px-2 py-1 text-muted-foreground">
                        <svg
                          ...
                          className="h-3 w-3 text-electric"
                        >
                          <path d="M15.4 15.4a5.3 5.3 0 0 1-7.8-1.4 5.3 5.3 0 0 1 1.4-7.8l5.6-5.6a5.3 5.3 0 0 1 7.8 7.8l-2.8 2.8" />
                          <path d="M8.6 8.6a5.3 5.3 0 0 1 7.8 1.4 5.3 5.3 0 0 1-1.4 7.8l-5.6 5.6a5.3 5.3 0 0 1-7.8-7.8l2.8-2.8" />
                        </svg>
                        {plan.calorieRange}
                      </span>
                    </div>
                    ...
                    <div className="mt-auto pt-4 flex items-center justify-between">
                      {unlocked ? (
                        ...
                        <div className="text-sm font-semibold text-foreground">{mealPrice}</div>
                      )}
        ...
        {!hasAllAccess && (
          <div className="mt-12 sm:mt-16 rounded-2xl border border-border/60 bg-onyx-100 p-6 sm:p-8 lg:p-10">
            <h2 className="font-display text-xl sm:text-2xl font-bold">
              {t("mealPlans.howItWorks.title")}
            </h2>
            <div className="mt-6 grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  n: "01",
                  t: t("mealPlans.howItWorks.step1.title"),
                  d: t("mealPlans.howItWorks.step1.desc"),
                },
                {
                  n: "02",
                  t: t("mealPlans.howItWorks.step2.title"),
                  d: t("mealPlans.howItWorks.step2.desc"),
                },
                {
                  n: "03",
                  t: t("mealPlans.howItWorks.step3.title"),
                  d: `${t("mealPlans.access.oneTime")} ${mealPrice}. ${t("mealPlans.howItWorks.step3.desc")}`,
                },
                {
                  n: "04",
                  t: t("mealPlans.howItWorks.step4.title"),
                  d: t("mealPlans.howItWorks.step4.desc"),
                },
              ].map((s) => (
