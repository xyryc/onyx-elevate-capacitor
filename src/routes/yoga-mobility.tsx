    ...
    sections: [
      {
        ...
        body: "Start on hands and knees. Inhale, drop the belly and lift the chest; exhale, round the spine toward the ceiling. Move slowly for 10–12 rounds. This wakes every segment of the spine and warms the shoulders and hips at the same time.",
      },
      {
        heading: "2. Low Lunge (both sides) • 2 minutes",
        body: "Step one foot forward, lower the back knee, and sink the hips gently until you feel a stretch across the front of the back hip. Reach the arms overhead if it feels good. Hold for 5–8 breaths per side. This opens the hip flexors that shorten from sleeping and sitting.",
      },
      {
        heading: "3. Standing Forward Fold • 1 minute",
        body: "Stand tall, hinge from the hips, and let the upper body hang. Keep a soft bend in the knees. Hold opposite elbows and sway gently side to side. Feel the spine decompress and the hamstrings wake up.",
      },
      {
        heading: "4. Three long breaths • 1 minute",
        body: "Roll up to standing one vertebra at a time. Stand still, close the eyes, and take three long nasal breaths — 4 counts in, 6 counts out. This is where the reset actually lands.",
      },
    ],
    takeaway: "Do this on the days you do not want to. Those are the days it matters most.",
  },
  {
    icon: Waves,
    ...
    sections: [
      {
        ...
        body: "A hamstring stretch is you sitting still and waiting for the muscle to lengthen. Mobility work is you actively controlling a joint through its full available range — with strength, not just gravity.",
      },
      {
        heading: "Why active range matters more",
        body: "Your body will only let you use the range it trusts. If you can passively touch your toes but cannot lift your leg to hip height under control, your nervous system treats the upper part of that range as unsafe — and locks you out of it during squats, deadlifts and sprints.",
      },
      {
        heading: "A simple weekly template",
        body: "Three mobility drills, three times a week, is enough to see a change in 4–6 weeks. Focus on the joints you actually use.",
        bullets: [
      ...
      },
      {
        ...
        body: "Static stretching still has a place — after a session, before bed, or when a specific muscle is chronically tight. Just do not rely on it alone if the goal is a body that moves well when it matters.",
      },
    ],
    takeaway: "Train the range. Own it. Then let it show up in your lifts.",
  },
  {
    icon: Flower2,
    ...
    sections: [
      {
        ...
        body: "Real recovery is not the absence of training — it is an active downshift of the nervous system. Sleep does most of the work, but the hours you are awake matter too. A slow practice teaches your body that it is safe to un-clench.",
      },
      {
        heading: "What 'slow' actually looks like",
        body: "No metrics. No music with a BPM. No pose you are chasing. You move at the pace of a full inhale and a longer exhale, and you let each shape settle before moving to the next one. If you finish and cannot remember the sequence, you did it right.",
      },
      {
        heading: "The training carryover",
        body: "Athletes who add 2–3 slow sessions per week often report better sleep, less nagging joint pain, faster warm-ups, and — the one nobody expects — better focus under a heavy bar. A calmer baseline makes the loud moments easier to handle.",
      },
      {
        heading: "How to start",
        body: "Pick a 15-minute window. Roll out a mat. Move through Cat–Cow, Child's Pose, Low Lunge, Seated Forward Fold and Savasana. Stay in each one long enough to feel bored — then stay one breath longer.",
      },
    ],
    takeaway: "Slow is not the opposite of strong. It is what makes strong sustainable.",
  },
  {
    icon: BookOpen,
    ...
    sections: [
      {
        ...
        body: "Breathe through the nose whenever possible — at rest, walking, and through the first two-thirds of most workouts. Nasal breathing filters and warms the air, produces nitric oxide (which helps oxygen delivery), and forces a slower, deeper breath. Mouth breathing is for the last hard reps, not the whole session.",
      },
      {
        heading: "2. Diaphragmatic breathing",
        body: "Lie on your back with one hand on your chest and one on your belly. Breathe in through the nose so only the belly hand rises. Exhale slowly. Ten breaths like this drops your heart rate, lowers stress hormones, and reminds your body which muscle is supposed to be running the show.",
      },
      {
        heading: "3. The box breath",
        body: "Inhale 4 counts, hold 4, exhale 4, hold 4. Repeat for 2–5 minutes. Used by Navy SEALs before missions and by lifters before max attempts. It is a fast, portable way to steady the nervous system when the moment matters.",
      },
      {
        heading: "When to use each",
        body: "Nasal breathing all day. Diaphragmatic breathing before bed and during cooldowns. Box breath before a heavy lift, a hard conversation, or any moment you want to walk into calmer than you feel.",
      },
    ],
    takeaway:
...
function PoseCard({ pose: p }: { pose: Pose }) {
  return (
    <Dialog>
      ...
      <DialogContent
        showClose={false}
        className="block w-full sm:w-[calc(100%-1rem)] max-w-full sm:max-w-3xl h-[100dvh] sm:h-auto max-h-[100dvh] sm:max-h-[92dvh] overflow-y-auto overscroll-contain p-0 pt-[env(safe-area-inset-top,0px)] sm:pt-0 bg-onyx-50 border-border/60 rounded-none sm:rounded-2xl [-webkit-overflow-scrolling:touch]"
      >
        ...
        <div className="px-4 pt-6 pb-[max(env(safe-area-inset-bottom),1rem)] sm:px-6 sm:pb-6">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-electric/20 bg-electric/5 p-4">
              ...
              <p className="mt-2 text-sm text-foreground/85 leading-relaxed">{p.breathing}</p>
            </div>
          </div>
          ...
          <p className="mt-6 text-xs text-muted-foreground/80 border-t border-border/60 pt-4">
            If a pose causes sharp pain, come out slowly. Yoga should challenge, not injure. Consult
            a health professional if you have injuries or medical concerns.
          </p>
        </div>
      </DialogContent>
    </Dialog>
    ...
    <div className="min-h-screen bg-onyx-50">
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="container-onyx relative py-20 md:py-28 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-base md:text-lg text-muted-foreground">
            A quiet space to breathe, stretch, and recover. Start with a featured practice, learn
            the foundational poses and stretches, and explore short reads on mindful movement.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-10 items-center">
          <div>
            ...
            <p className="mt-5 text-base text-foreground/80 leading-relaxed">
              A gentle, accessible session to ease into your practice. Follow along at your own pace
              - modify freely and let the breath lead each movement. This is the perfect starting
              point whether you're brand new to yoga or returning after time away.
            </p>
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Roll out a mat, dim the lights, and give yourself these twenty minutes. Consistency
              beats intensity - even a short daily practice will move you further than a long
              session once a week.
            </p>
            <div className="mt-6 rounded-md border border-border/60 bg-onyx-100/60 p-4 text-xs text-muted-foreground">
              This video is provided by the original creator and embedded from YouTube. All rights
              belong to the respective channel.
            </div>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-[1.1fr_1fr] items-stretch">
          <div className="surface-card rounded-2xl p-8 md:p-10 flex flex-col justify-center">
            ...
            <p className="mt-3 text-sm md:text-base text-muted-foreground leading-relaxed">
              You don't need a hundred exercises — you need a handful of high-quality moves,
              practiced with attention. Explore the video library below, learn the postures, and
              feel the difference.
            </p>
          </div>
      ...
      <section className="container-onyx py-6 md:py-10">
        <div className="mb-6 flex items-end justify-between gap-4">
          ...
          <Dialog>
            ...
            <DialogContent
              showClose={false}
              className="block w-full sm:w-[calc(100%-1rem)] max-w-full sm:max-w-5xl h-[100dvh] sm:h-[92dvh] max-h-[100dvh] sm:max-h-[92dvh] overflow-y-auto overscroll-contain p-0 bg-onyx-50 border-border/60 rounded-none sm:rounded-2xl [-webkit-overflow-scrolling:touch]"
            >
      ...
      <section className="container-onyx py-14 md:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {articles.map((a) => (
            <Dialog key={a.title}>
              ...
              <DialogContent
                showClose={false}
                className="block w-full sm:w-[calc(100%-1rem)] max-w-full sm:max-w-2xl h-[100dvh] sm:h-auto max-h-[100dvh] sm:max-h-[92dvh] overflow-y-auto overscroll-contain p-0 pt-[env(safe-area-inset-top,0px)] sm:pt-0 bg-onyx-50 border-border/60 rounded-none sm:rounded-2xl [-webkit-overflow-scrolling:touch]"
              >
                <DialogCloseX className="absolute right-3 top-[calc(12px+env(safe-area-inset-top,0px))] sm:top-3 z-50" />
                ...
                <div className="px-4 pt-6 pb-[max(env(safe-area-inset-bottom),1rem)] sm:px-6 sm:pb-6">
                  ...
                  <p className="mt-4 text-base text-foreground/90 leading-relaxed">{a.intro}</p>
        ...
        <p className="mt-12 text-xs text-muted-foreground/80 text-center max-w-2xl mx-auto">
          Onyx Elevate does not own the third-party videos embedded on this page. They are curated
          for educational and wellness purposes.
        </p>
      </section>
    </div>
  );
