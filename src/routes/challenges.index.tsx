  ...
  head: () => ({
    meta: [
      { title: "Onyx Challenges · Pick a fight. Finish it." },
      {
        name: "description",
        content:
          "25+ free Onyx fitness challenges, 10K steps, 75 Hard, push-ups, cold showers, no sugar, handstands and more. Join in one tap, earn a badge.",
      },
      { property: "og:title", content: "Onyx Challenges" },
      {
        property: "og:description",
        content: "Free fitness challenges to reset your habits, build a base, and earn a badge.",
      },
    ],
  }),
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className="absolute top-1.5 left-1.5 flex flex-wrap gap-1">
                  <span className="px-1.5 py-0.5 rounded bg-electric text-onyx-50 text-[9px] font-bold uppercase tracking-wider">
                    {c.durationDays}d
                  </span>
                  <span className="px-1.5 py-0.5 rounded bg-onyx-50/80 backdrop-blur border border-border text-[9px] font-semibold hidden sm:inline-block">
                    {c.category}
                  </span>
                </div>
              ...
              <div className="p-2.5 sm:p-4">
                <h2 className="font-display text-sm sm:text-base font-bold leading-tight group-hover:text-electric transition-colors line-clamp-2">
                  {c.title}
                </h2>
