...
export const Route = createFileRoute("/coaches/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Meet the Onyx Elevate coaches and competitors behind every program.",
      },
    ...
    <section className="container-onyx py-16">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-muted-foreground">
          Competitors, founders, and specialists behind every Onyx program.
        </p>
      </div>
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {sorted.map((c) => (
          <CoachDialog key={c.slug} coach={c}>
            <button
              type="button"
              className="text-left group surface-card rounded-xl overflow-hidden hover:border-electric/40 transition-all"
            >
