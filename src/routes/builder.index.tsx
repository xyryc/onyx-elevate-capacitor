...
function BuilderIndex() {
  ...
  const createMut = useMutation({
    mutationFn: () => createFn({ data: { name: newName || t("builder.untitled"), daysPerWeek, weeks: weeksCount } }),
  ...
  return (
    <div className="relative h-full overflow-hidden md:min-h-screen md:overflow-visible">
      ...
      <header>
        <p className="text-[11px] font-semibold uppercase tracking-widest text-electric md:text-sm">{t("builder.eyebrow")}</p>
      ...
      <div className="rounded-xl border border-electric/20 bg-electric/10 p-2.5 md:p-4">
        <p className="text-[11px] font-semibold uppercase tracking-wider text-electric md:text-sm">{t("builder.featuresTitle")}</p>
