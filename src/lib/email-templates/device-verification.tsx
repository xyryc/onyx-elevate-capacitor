...
const DeviceVerificationEmail = ({ code, deviceLabel, siteName }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>
      Your {siteName} sign-in code: {code}
    </Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>New device sign-in</Heading>
        <Text style={text}>
          Someone (hopefully you) just signed in to your {siteName} account from a new device:{" "}
        ...
        <Text style={warning}>
          If this wasn't you, someone may have your password. Change it immediately and do not enter
          this code anywhere.
        </Text>
        <Text style={footer}>
