...
const RULES: { allergen: Allergen; patterns: RegExp[] }[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bnut butter\b/i, /\bmixed nuts\b/i, /\bcoconut\b/i,
    ],
  },
  {
    allergen: "Dairy",
    patterns: [
      /\bmilk\b/i, /\bcheese\b/i, /\bcheddar\b/i, /\bparmesan\b/i, /\bfeta\b/i,
      /\bmozzarella\b/i, /\bricotta\b/i, /\byogurt\b/i, /\bgreek yogurt\b/i,
      /\bbutter\b/i, /\bcream\b/i, /\bwhey\b/i, /\bcasein\b/i,
      /\bcottage cheese\b/i, /\bkefir\b/i, /\bghee\b/i,
    ],
  },
  {
    allergen: "Eggs",
  ...
  },
  {
    allergen: "Gluten",
    patterns: [
      /\bwheat\b/i, /\bflour\b/i, /\bbread\b/i, /\btortilla/i, /\bwrap\b/i,
      /\bpasta\b/i, /\bnoodle/i, /\bcouscous\b/i, /\bbulgur\b/i, /\bbarley\b/i,
      /\brye\b/i, /\bsoy sauce\b/i, /\bseitan\b/i, /\bpanko\b/i, /\bbreadcrumb/i,
      /\bpita\b/i, /\bbagel\b/i, /\bcracker/i,
    ],
  },
  {
    allergen: "Soy",
    patterns: [/\bsoy\b/i, /\bsoya\b/i, /\btofu\b/i, /\btempeh\b/i, /\bedamame\b/i, /\bmiso\b/i, /\btamari\b/i],
  },
  {
    allergen: "Fish",
    patterns: [/\bsalmon\b/i, /\btuna\b/i, /\bcod\b/i, /\btilapia\b/i, /\btrout\b/i, /\bsardine/i, /\banchov/i, /\bmackerel\b/i, /\bfish sauce\b/i, /\bchar\b/i],
  },
  {
    allergen: "Shellfish",
    patterns: [/\bshrimp\b/i, /\bprawn/i, /\bcrab\b/i, /\blobster\b/i, /\bscallop/i, /\bmussel/i, /\bclam\b/i, /\boyster/i, /\bsquid\b/i, /\bcalamari\b/i],
  },
  {
    allergen: "Sesame",
