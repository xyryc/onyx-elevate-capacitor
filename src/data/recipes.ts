...
export type RecipeDiet = "High Protein" | "Low Carb" | "Vegan" | "Vegetarian" | "Gluten Free" | "Dairy Free";
...
export const recipes: Recipe[] = [
  {
    ...
    tagline: "50g of clean protein, slow-burning carbs and a hit of healthy fats - built for post-lift refuel.",
  ...
  },
  {
    ...
    tagline: "Complete post-training plate: omega-3 protein, fast carbs and micronutrient-dense greens.",
    category: "Dinner",
    diets: ["High Protein", "Gluten Free", "Dairy Free"],
    image: salmon,
    prepTime: 10,
  ...
  },
  {
    ...
    tagline: "30g protein, antioxidant-dense, ready in 3 minutes - the lazy lifter's secret weapon.",
    category: "Snacks",
    diets: ["High Protein", "Vegetarian"],
    image: parfait,
    prepTime: 3,
  ...
  },
  {
    ...
    storage: "4 days refrigerated. Reheats best in a skillet, 4 minutes covered, then 1 minute uncovered.",
    swaps: [
  ...
  },
  {
    ...
    tagline: "Spinach, banana, protein and pineapple - 32g protein in a glass that doesn't taste like grass.",
    category: "Smoothies",
    diets: ["High Protein", "Vegetarian", "Gluten Free"],
    image: smoothieGreen,
    prepTime: 5, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 410, protein: 32, carbs: 52, fat: 8 },
    summary: "A green smoothie that actually tastes like dessert. Pineapple and banana mask the spinach completely while delivering recovery-grade vitamins.",
    whyItWorks: ["Spinach delivers nitrates that improve training endurance.", "Pineapple bromelain aids protein digestion and reduces soreness.", "Vanilla whey gives 25g of fast-absorbing recovery protein."],
    ingredients: [{ items: ["2 cups baby spinach","1 frozen banana","1 cup frozen pineapple","1 scoop vanilla whey","1 tbsp chia seeds","300 ml coconut water","Ice as needed"] }],
    instructions: [
    ...
    proTips: ["Freeze banana in coins for easier blending.","Add 1 tsp matcha for caffeine pre-workout.","A squeeze of lime brightens the entire flavor."],
    storage: "Best fresh. Will oxidize within 2 hours.",
    swaps: ["Plant protein for fully vegan.","Mango instead of pineapple.","Add 1/4 avocado for creaminess and extra fats."],
    pairsWith: ["onyx-hypertrophy","fat-loss-blueprint"],
  },
  {
    ...
    diets: ["High Protein", "Vegetarian", "Gluten Free"],
    image: smoothieBerry,
    prepTime: 4, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 385, protein: 30, carbs: 48, fat: 9 },
    summary: "The post-leg-day smoothie. Mixed berries are the most polyphenol-dense fruit category - proven to reduce DOMS.",
    whyItWorks: ["Anthocyanins in berries reduce muscle soreness.","Greek yogurt + whey = blended fast and slow protein.","Flaxseed adds omega-3 ALA for joint support."],
    ingredients: [{ items: ["1 cup mixed frozen berries","1 scoop vanilla whey","1/2 cup Greek yogurt","1 tbsp ground flaxseed","250 ml almond milk","Drizzle of honey"] }],
    instructions: [
    ...
    proTips: ["Frozen wild blueberries punch above their weight on antioxidants.","A pinch of cinnamon balances tartness.","Use kefir for gut-health bonus."],
    storage: "Best fresh.",
    swaps: ["Cottage cheese for yogurt for extra casein.","Plant milk + plant protein for vegan.","Add oats for a meal-replacement version."],
    pairsWith: ["powerbuild-peaking","onyx-hypertrophy"],
  },
  {
    ...
    summary: "A bright tropical smoothie loaded with curcumin - your joints will thank you on heavy training blocks.",
    whyItWorks: ["Curcumin + black pepper combo boosts absorption ~2000%.","Mango provides quick-acting carbs for energy.","Ginger settles the stomach pre-workout."],
    ingredients: [{ items: ["1 cup frozen mango","1 scoop vanilla plant protein","1 tsp ground turmeric","Pinch black pepper","1 tsp grated ginger","300 ml coconut milk drink","Squeeze of lime"] }],
    instructions: [
    ...
    proTips: ["Use fresh ginger for kick, ground for mellow warmth.","Add 1 tbsp MCT oil for sustained energy.","A frozen banana adds creaminess."],
    storage: "Best fresh.",
    swaps: ["Pineapple instead of mango.","Whey if not vegan.","Coconut water for a lighter version."],
    pairsWith: ["women-over-40","fat-loss-blueprint"],
  },
  {
    ...
    summary: "When the scale won't move, drink this. Calorie-dense, easy to consume, hits all macros.",
    whyItWorks: ["High-calorie liquid is the easiest way to push a surplus.","PB + oats = sustained energy and clean fats.","45g protein supports muscle building targets."],
    ingredients: [{ items: ["2 ripe bananas","2 tbsp peanut butter","1/2 cup rolled oats","1.5 scoops chocolate whey","350 ml whole milk","1 tbsp honey","Ice"] }],
    instructions: [
    ...
    proTips: ["Add 1 tbsp coconut oil to push 700 kcal.","Use frozen banana for a thick shake-like texture.","Drink with a straw to consume faster on bad-appetite days."],
    storage: "Best fresh, but holds 12 hours in fridge.",
    swaps: ["Almond butter or sunflower butter.","Plant milk to cut calories slightly.","Add cacao nibs for crunch."],
    pairsWith: ["onyx-hypertrophy","powerbuild-peaking"],
  },
  {
    ...
    summary: "Drink your vacation. Tropical fruit blends with vanilla protein for a post-workout shake that feels like a treat.",
    whyItWorks: ["Pineapple bromelain reduces inflammation.","Coconut adds quick energy fats (MCTs).","Greek yogurt delivers slow-release casein."],
    ingredients: [{ items: ["1 cup frozen pineapple","1 cup frozen mango","1 scoop vanilla whey","1/2 cup Greek yogurt","200 ml coconut water","1 tbsp shredded coconut"] }],
    instructions: [
    ...
    proTips: ["Use real coconut water, not from concentrate.","Add a passionfruit for tang.","Freeze leftovers as popsicles."],
    storage: "Best fresh.",
    swaps: ["Plant protein and coconut yogurt for vegan.","Add spinach for hidden greens.","Banana for thicker texture."],
  ...
  },
  {
    ...
    summary: "Underrated and overpowered. Cottage cheese has more protein per gram than Greek yogurt and is the perfect base for a snack-meal.",
    whyItWorks: ["Cottage cheese is 80% casein - slow protein perfect before bed.","Berries add antioxidants and natural sweetness.","Nuts add satiating fats."],
    ingredients: [{ items: ["1 cup 2% cottage cheese","1/2 cup mixed berries","1 tbsp chopped walnuts","1 tsp honey","Pinch cinnamon","Lemon zest"] }],
    instructions: [
    ...
    proTips: ["Whip the cottage cheese in a blender for a yogurt-like texture.","Pre-bed snack - slow casein supports muscle recovery overnight.","Add a scoop of vanilla whey for 50g protein."],
    storage: "Best fresh.",
    swaps: ["Greek yogurt if cottage cheese isn't your thing.","Pumpkin seeds instead of walnuts.","Stevia for zero-sugar."],
  ...
  },
  {
    ...
    diets: ["High Protein", "Dairy Free"],
    image: tunaToast,
    prepTime: 5, cookTime: 2, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 445, protein: 35, carbs: 38, fat: 17 },
    summary: "The ultimate lazy lunch. A can of tuna and a ripe avocado on toast hits every macro in 5 minutes flat.",
    whyItWorks: ["Tuna is the cheapest high-quality protein in the supermarket.","Avocado supplies monounsaturated fats for hormones.","Sourdough delivers slow carbs without spiking blood sugar."],
    ingredients: [{ items: ["1 can (140 g) tuna in water, drained","1/2 ripe avocado","2 slices sourdough","1 tbsp Greek yogurt or mayo","Juice of 1/2 lemon","Red pepper flakes","Microgreens","Salt and pepper"] }],
    instructions: [
    ...
    proTips: ["Buy line-caught skipjack - lower mercury than albacore.","Add capers for a briny kick.","Use seeded rye for extra fiber."],
    storage: "Best fresh - toast goes soggy.",
    swaps: ["Canned salmon or sardines for omega-3s.","Cottage cheese instead of yogurt.","Gluten-free bread."],
    pairsWith: ["fat-loss-blueprint","women-over-40"],
  },
  {
    ...
    diets: ["High Protein", "Vegetarian", "Gluten Free"],
    image: pancakes,
    prepTime: 2, cookTime: 5, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 360, protein: 30, carbs: 38, fat: 9 },
    summary: "The simplest high-protein breakfast in existence. Banana, eggs, oats - blend and pour.",
    whyItWorks: ["Whole eggs deliver leucine to trigger muscle protein synthesis.","Oats give slow carbs to fuel morning sessions.","No protein powder needed - pure whole food."],
    ingredients: [{ items: ["1 ripe banana","2 whole eggs","1/2 cup rolled oats","1/2 tsp baking powder","Pinch cinnamon","Berries and Greek yogurt to top"] }],
    instructions: [
    ...
    proTips: ["Let batter rest 2 minutes - fluffier pancakes.","Add a scoop of vanilla whey for 50g protein.","Medium-low heat avoids burning the outside before the inside sets."],
    storage: "Hold 3 days refrigerated. Reheat in toaster.",
    swaps: ["Cottage cheese for an even higher protein version.","Plant milk + flax egg for vegan.","Buckwheat flour for nuttier flavor."],
    pairsWith: ["beginner-foundations","onyx-hypertrophy"],
  },
  {
    ...
    summary: "The classic Caesar, rebuilt for athletes. Greek-yogurt-based dressing keeps macros lean without losing the creamy edge.",
    whyItWorks: ["Greek yogurt cuts ~200 kcal vs. classic Caesar dressing.","Romaine is high volume, low calorie - perfect on a cut.","Chicken breast keeps the protein-to-calorie ratio elite."],
    ingredients: [
      { title: "Salad", items: ["2 chicken breasts (~300 g)","2 heads romaine, chopped","30 g shaved parmesan","2 tbsp olive oil","Salt, pepper"] },
      { title: "Dressing", items: ["1/2 cup Greek yogurt","1 tbsp Dijon","1 tbsp lemon juice","1 garlic clove, grated","2 anchovies, mashed","1 tbsp grated parmesan","Cracked pepper"] }
    ],
    instructions: [
    ...
    proTips: ["Brine chicken in salt water 30 minutes for juiciness.","Toast a handful of sourdough cubes for low-carb-friendly croutons.","Anchovies are non-negotiable for real Caesar flavor."],
    storage: "Dressing keeps 5 days. Build salads to order.",
    swaps: ["Air-fryer chickpeas for vegan version.","Grilled salmon for omega-3 boost.","Kale instead of romaine for extra nutrients."],
    pairsWith: ["fat-loss-blueprint","powerbuild-peaking"],
  },
  {
    ...
    summary: "A Mediterranean weeknight winner. Lemon, oregano, garlic - pantry herbs that turn basic chicken into something memorable.",
    whyItWorks: ["Olive oil polyphenols support cardiovascular health.","Chickpeas add plant protein and fiber to balance the dish.","Lemon brightens and aids iron absorption from greens."],
    ingredients: [{ items: ["700 g chicken thighs","1 can chickpeas, drained","2 zucchini, sliced","1 red onion, wedged","250 g cherry tomatoes","100 g feta, cubed","3 tbsp olive oil","2 tsp dried oregano","Juice and zest of 1 lemon","4 garlic cloves, smashed","Salt, pepper, parsley"] }],
    instructions: [
    ...
    proTips: ["Don't crowd the pan - use two if needed.","Drain chickpeas well so they crisp instead of steam.","Reserve the pan juices - pour over rice or pita all week."],
    storage: "4 days refrigerated. Reheats brilliantly.",
    swaps: ["Halloumi for feta if you want it grillable.","Olives and capers for more Mediterranean punch.","Swap chickpeas for white beans."],
    pairsWith: ["women-over-40","fat-loss-blueprint"],
  },
  {
    ...
    summary: "A week's worth of grab-and-go breakfast. Two bites = 22g protein. Cheaper than Starbucks and the protein hits twice as hard.",
    whyItWorks: ["Egg whites are pure, cheap, fat-free protein.","Cottage cheese baked in adds creaminess without dairy heaviness.","Portion-controlled - exact macros every morning."],
    ingredients: [{ items: ["12 large egg whites (or 360 ml carton)","1/2 cup cottage cheese","60 g shredded gruyere or cheddar","100 g cooked turkey bacon, chopped","1/2 cup spinach, chopped","2 tbsp diced red pepper","Salt, pepper"] }],
    instructions: [
    ...
    proTips: ["Use silicone muffin cups - zero sticking.","Water bath at the bottom of the oven keeps them custardy.","Reheat 30 seconds in the microwave."],
    storage: "5 days refrigerated, 1 month frozen.",
    swaps: ["Skip meat for fully vegetarian.","Goat cheese for a tangier bite.","Add diced jalapeño for heat."],
    pairsWith: ["fat-loss-blueprint","women-over-40"],
  },
  {
    slug: "chicken-rice-veg-meal-prep",
    title: "Chicken, Rice & Veg Meal Prep",
    tagline: "Four containers, one Sunday afternoon - 45g protein per meal for the entire work week.",
    category: "Meal Prep",
    diets: ["High Protein", "Gluten Free", "Dairy Free"],
    ...
    summary: "The blueprint meal prep. Batch-cook one tray of chicken, one pot of rice, one tray of veg on Sunday. Portion into four containers. Lunch is solved Monday through Thursday - no thinking, no excuses, exact macros every time.",
    whyItWorks: [
    ...
    storage: "4 days refrigerated in sealed glass containers. Reheat 2 minutes in the microwave with a splash of water over the rice. Freeze portions 1 & 2 if you cook for 5+ days - thaw overnight in the fridge.",
    swaps: [
  ...
  },
  {
    ...
    summary: "Dessert that fits the macros. Chia pudding tastes like rich chocolate mousse and quietly delivers omega-3s and fiber.",
    whyItWorks: ["Chia delivers ALA omega-3 and 12g fiber for gut health.","Plant protein boosts it from snack to muscle-building.","Cocoa polyphenols help with recovery."],
    ingredients: [{ items: ["1/4 cup chia seeds","1 scoop chocolate plant protein","2 tbsp cocoa powder","2 tbsp maple syrup","350 ml almond milk","1 tsp vanilla","Pinch sea salt","Raspberries to top"] }],
    instructions: [
    ...
    proTips: ["Whisk twice in the first 10 minutes - solves all clumping.","Layer with peanut butter for a Reese's-style cup.","Blend the set pudding for a mousse texture."],
    storage: "5 days refrigerated.",
    swaps: ["Whey instead of plant protein.","Coconut milk for richer pudding.","Strawberries or sliced banana on top."],
    pairsWith: ["women-over-40","fat-loss-blueprint"],
  },
  {
    slug: "shakshuka-eggs",
    ...
    diets: ["High Protein", "Vegetarian", "Low Carb", "Gluten Free"],
    image: shakshuka,
    prepTime: 5, cookTime: 18, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 395, protein: 28, carbs: 18, fat: 24 },
    summary: "Eggs poached in a smoky tomato pepper sauce, finished with feta. Hits like a restaurant brunch but you made it.",
    whyItWorks: ["Whole eggs deliver complete protein + choline.","Tomatoes provide lycopene - best absorbed when cooked in oil.","High volume keeps you full on a cut."],
    ingredients: [{ items: ["1 tbsp olive oil","1 onion, diced","1 red bell pepper, diced","3 garlic cloves, minced","2 tsp smoked paprika","1 tsp cumin","1/2 tsp chili flakes","1 can (400 g) crushed tomatoes","4 large eggs","60 g feta, crumbled","Fresh parsley","Salt, pepper, sourdough to serve"] }],
    instructions: [
    ...
    proTips: ["Cover the pan = poached whites, runny yolks.","Add a tsp of harissa for restaurant-grade depth.","Save the sauce for pasta later in the week."],
    storage: "Sauce holds 4 days. Eggs are best fresh.",
    swaps: ["Chickpeas added for vegan version (drop eggs).","Goat cheese instead of feta.","Add chorizo for meat lovers."],
    pairsWith: ["women-over-40","fat-loss-blueprint"],
  },
  // ── Extra recipes per category ────────────────────────────────────────────
  {
    ...
    diets: ["High Protein", "Gluten Free", "Dairy Free"],
    image: steakRice,
    prepTime: 5, cookTime: 12, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 685, protein: 55, carbs: 72, fat: 18 },
    summary: "Lean sirloin seared hot, served over jasmine rice with charred broccoli. No nonsense fuel.",
    whyItWorks: ["Sirloin is leaner than ribeye but still flavor-loaded.","Jasmine rice refills glycogen fast post-lift.","Broccoli adds volume and micros without the calorie cost."],
    ingredients: [{ items: ["220 g sirloin steak","1 cup cooked jasmine rice","1 cup broccoli florets","2 tsp olive oil","Salt, pepper, soy sauce"] }],
    instructions: [
    ...
    proTips: ["Rest the steak, non-negotiable for juicy slices.","A splash of soy + butter at the end = restaurant finish."],
  ...
  },
  {
    ...
    whyItWorks: ["Casein-dominant cottage cheese drips amino acids slowly.","Berries add antioxidants without spiking blood sugar.","Crunch + creamy textures keep you reaching for it."],
    ingredients: [{ items: ["250 g cottage cheese","100 g mixed berries","30 g granola","1 tsp honey","Cinnamon"] }],
    instructions: [
    ...
    proTips: ["Stir in a scoop of vanilla whey for 60g+ protein.","Use frozen berries, they thaw into a jam-like syrup."],
  ...
  },
  {
    ...
    whyItWorks: ["Olive-oil tuna pairs protein with omega-3s.","Chickpeas add slow carbs + fiber for steady energy.","Cold, crunchy, packs without going soggy."],
    ingredients: [{ items: ["1 can (150 g) tuna in olive oil","1/2 cup chickpeas","1 cucumber, diced","100 g cherry tomatoes","1/4 red onion, sliced","1 tbsp olive oil","1/2 lemon, juiced","Salt, pepper, oregano"] }],
    instructions: [
  ...
  },
  {
    ...
    summary: "High-protein pasta tossed with grilled chicken, pesto, cherry tomatoes, and parmesan.",
    whyItWorks: ["Lentil/chickpea pasta nearly doubles the protein per serving.","Pesto delivers fats + flavor without sauce-bloat.","Tomatoes burst and become the sauce."],
    ingredients: [{ items: ["160 g high-protein pasta","250 g chicken breast, cubed","2 tbsp pesto","150 g cherry tomatoes","20 g parmesan","Olive oil, salt, pepper, basil"] }],
    instructions: [
    ...
    proTips: ["Toast pine nuts on top for extra crunch.","A squeeze of lemon brightens the whole bowl."],
  ...
  },
  {
    ...
    prepTime: 15, cookTime: 35, servings: 4, difficulty: "Moderate",
    macrosPerServing: { calories: 410, protein: 38, carbs: 14, fat: 22 },
    summary: "Zucchini ribbons layered with lean beef ragu and ricotta. Comfort food, cut-friendly.",
    whyItWorks: ["Zucchini swaps pasta sheets, 80% fewer carbs.","Lean beef + ricotta = complete protein punch.","Holds in the fridge, built for batch eating."],
    ingredients: [{ items: ["3 large zucchini, sliced lengthwise","500 g lean ground beef","1 jar marinara","250 g ricotta","1 egg","100 g mozzarella","Salt, pepper, basil"] }],
    instructions: [
    ...
    proTips: ["Sweating zucchini = no watery lasagna.","Let it rest 10 min before slicing, cleaner cuts."],
  ...
  },
  {
    ...
    whyItWorks: ["Thighs stay juicy + add satiating fat.","Cauli rice cuts carbs hard while keeping the bowl-feel.","One pan, almost no cleanup."],
    ingredients: [{ items: ["200 g chicken thighs, diced","2 cups cauliflower rice","3 garlic cloves, minced","1 tbsp olive oil","1 tsp paprika","Salt, pepper, parsley","Lemon wedge"] }],
    instructions: [
  ...
  },
  {
    ...
    whyItWorks: ["Tofu + quinoa together form a complete amino profile.","Tahini adds healthy fats + creamy richness.","Roasting concentrates sweetness in the potato + kale."],
    ingredients: [{ items: ["300 g firm tofu, cubed","1 cup cooked quinoa","1 sweet potato, cubed","2 cups kale, torn","2 tbsp olive oil","2 tbsp tahini","1 tbsp lemon juice","1 tbsp soy sauce","Salt, pepper, garlic powder"] }],
    instructions: [
    ...
    proTips: ["Cornstarch on tofu = crispy edges.","Don't skip massaging the kale, texture changes completely."],
  ...
  },
  {
    ...
    whyItWorks: ["Lentils + beans = serious plant protein + fiber.","Smoked paprika + cocoa give it depth without meat.","Freezes perfectly, make once, eat all week."],
    ingredients: [{ items: ["1 cup dry lentils","1 can black beans","1 can kidney beans","1 can crushed tomatoes","1 onion, diced","3 garlic cloves","2 tsp smoked paprika","2 tsp cumin","1 tsp cocoa powder","2 cups vegetable broth","Salt, pepper, cilantro"] }],
    instructions: [
  ...
  },
  {
    ...
    whyItWorks: ["Salmon = protein + omega-3s in one move.","Rice + broccoli are the perfect post-lift base.","Glaze hits every box with restaurant flavor."],
    ingredients: [{ items: ["4 × 150 g salmon fillets","2 cups cooked jasmine rice","400 g broccoli florets","3 tbsp soy sauce","2 tbsp honey","1 tbsp rice vinegar","1 tsp ginger","1 tsp garlic","Sesame seeds, green onion"] }],
    instructions: [
    ...
    proTips: ["Reserve a spoon of glaze raw, drizzle when reheating.","Slightly under-cook salmon, it finishes in the microwave."],
  ...
  },
  {
    ...
    whyItWorks: ["Whey + eggs in the custard = 35g protein per plate.","Sourdough holds the soak without going mushy.","Berries deliver antioxidants + natural sweetness."],
    ingredients: [{ items: ["2 slices sourdough","1 scoop vanilla whey","2 eggs","60 ml milk","1/2 tsp cinnamon","1/2 tsp vanilla","Butter for pan","100 g berries","1 tsp maple syrup"] }],
    instructions: [
    ...
    proTips: ["Use day-old bread, soaks better, holds shape.","Sub almond milk if avoiding dairy."],
  ...
  },
  {
    ...
    diets: ["High Protein", "Vegetarian"],
    image: riceCakes,
    prepTime: 3, cookTime: 0, servings: 1, difficulty: "Easy",
    ...
    whyItWorks: ["Cottage cheese is slow-release casein-rich protein.","Rice cakes give crunch without carb overload.","Honey + almonds = perfect sweet/salty balance."],
    ingredients: [{ items: ["3 brown rice cakes","150 g cottage cheese","1 tsp honey","10 g crushed almonds","Cinnamon"] }],
    instructions: [
  ...
  },
  {
    ...
    tagline: "Creamy peanut butter oats crowned with a fistful of fresh berries, 38g protein, 0 shortcuts.",
    category: "Breakfast",
    diets: ["High Protein", "Vegetarian"],
    ...
    summary: "A creamy peanut-butter Greek yogurt base loaded with mixed berries. High-protein, high-fiber and naturally sweet, the kind of breakfast that keeps you full through a heavy lift or a long meeting.",
    whyItWorks: [
    ...
    storage: "Best fresh. Prep the yogurt base up to 24h in advance, add berries and PB before serving.",
    swaps: ["Almond butter instead of peanut butter.","Skyr or cottage cheese instead of Greek yogurt.","Any single berry works if that's what's in the fridge."],
  ...
  },
  {
    ...
    tagline: "Post-workout dessert that actually rebuilds you, 42g protein, dark chocolate, real banana.",
    category: "High Protein",
    diets: ["High Protein", "Vegetarian"],
    image: chocolateBananaBowl,
    prepTime: 5, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 465, protein: 42, carbs: 58, fat: 9 },
    summary: "A thick chocolate protein pudding topped with sliced banana, dark chocolate shavings and a drizzle of chocolate sauce. Tastes like a cheat meal, hits your macros like a supplement stack.",
    whyItWorks: [
    ...
    swaps: ["Cottage cheese blended smooth instead of Greek yogurt.","Cacao nibs instead of chocolate shavings for less sugar."],
  ...
  },
  {
    ...
    tagline: "Vanilla-banana smoothie bowl with toasted coconut and crunchy granola, light, tropical, 32g protein.",
    category: "Breakfast",
    diets: ["High Protein", "Vegetarian", "Gluten Free"],
    image: bananaProteinBowl,
    prepTime: 5, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 425, protein: 32, carbs: 55, fat: 11 },
    summary: "A silky vanilla-banana smoothie bowl that eats like a tropical vacation. Blended thick so you spoon it instead of drink it, then finished with toasted coconut and crunchy granola for texture.",
    whyItWorks: [
    ...
    swaps: ["Plant protein and coconut yogurt for a fully vegan version.","Mango chunks instead of banana for a tangier tropical hit."],
  ...
  },
  {
    ...
    tagline: "Antioxidant-loaded blueberry smoothie bowl with granola crunch and coconut, 30g protein.",
    category: "Breakfast",
    diets: ["High Protein", "Vegetarian"],
    image: blueberryCrunchBowl,
    prepTime: 5, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 410, protein: 30, carbs: 58, fat: 8 },
    summary: "A deep-purple blueberry smoothie bowl loaded with fresh berries, crunchy granola and coconut. Sweet, tart and packed with the kind of antioxidants that make heavy training weeks recoverable.",
    whyItWorks: [
    ...
    storage: "Best fresh. Pre-portion frozen fruit + dry protein in zip bags for 60-second morning prep.",
    swaps: ["Cottage cheese blended smooth instead of Greek yogurt.","Mixed berries if blueberries aren't in season."],
  ...
  // ============ NEW REAL-PHOTO RECIPES ============
  {
    ...
    summary: "A restaurant-style poke-bar bowl you can put together in under 25 minutes. The honey-sriracha glaze caramelizes on the salmon and drips into warm rice below.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "2 x 170 g salmon fillets, skin on",
      "1 tbsp honey", "1 tbsp sriracha", "1 tbsp soy sauce", "1 tsp toasted sesame oil",
      "1 cup jasmine rice (dry)", "1 cup shelled edamame", "1 cucumber, sliced",
      "1 avocado, sliced", "2 tbsp pickled ginger", "Sesame seeds and sliced scallion to finish",
    ]}],
    instructions: [
    ...
    proTips: ["Pat salmon dry before searing - a wet fillet steams instead of crisping.", "Double the glaze and use it on tofu or chicken later in the week."],
    storage: "Store rice and salmon separately up to 3 days. Reheat salmon gently in a covered pan with a splash of water.",
    swaps: ["Cauliflower rice to cut carbs in half.", "Tofu instead of salmon for a plant-based version."],
  ...
  },
  {
    ...
    summary: "The lazy-cook meal prep move: chicken thighs, chickpeas and vegetables tossed in harissa on one sheet pan. Deep smoky flavor with basically zero dishes.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      ...
      "1 can chickpeas, drained", "2 red bell peppers, chunked",
      "1 red onion, wedged", "2 zucchini, sliced thick",
      "3 tbsp harissa paste", "2 tbsp olive oil", "1 lemon", "Salt, cumin, smoked paprika",
    ...
    proTips: ["Line the pan with parchment - harissa stains and burns onto metal.", "Save the pan drippings and spoon them over the reheated portions - that's where the flavor lives."],
    storage: "Refrigerate 4 days. Reheat covered at 180 °C for 10 minutes to keep chicken moist.",
    swaps: ["Tofu and extra chickpeas for a vegan tray.", "Cauliflower and broccoli instead of zucchini in winter."],
    pairsWith: ["onyx-hypertrophy", "fat-loss-blueprint"],
  },
  {
    slug: "steak-chimichurri-plate",
    title: "Steak & Chimichurri Plate",
    tagline: "Seared flank steak, bright herb sauce, roasted potatoes - 52g protein steakhouse night in.",
    category: "Dinner",
    diets: ["High Protein", "Gluten Free"],
    image: "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=1200&q=80",
    prepTime: 15, cookTime: 15, servings: 2, difficulty: "Moderate",
    macrosPerServing: { calories: 680, protein: 52, carbs: 45, fat: 30 },
    summary: "Weekend steakhouse energy on a Tuesday. Flank steak seared hard, sliced against the grain, drenched in a bright garlic-parsley chimichurri that cuts through the fat.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Plate", items: ["400 g flank steak", "500 g baby potatoes, halved", "1 tbsp olive oil", "Salt and pepper", "Rocket to serve"] },
      { title: "Chimichurri", items: ["1 large bunch parsley, finely chopped", "3 garlic cloves, minced", "2 tbsp red wine vinegar", "1/2 cup olive oil", "1 tsp red pepper flakes", "1/2 tsp salt"] },
    ],
    instructions: [
    ...
    proTips: ["Rest longer than you think - a rushed steak bleeds all its juice onto the board.", "Chimichurri keeps a week and rescues any bland leftover protein."],
    storage: "Steak refrigerates 3 days. Chimichurri lasts 7 days in the fridge, actually improves overnight.",
    swaps: ["Sirloin or hangar steak work equally well.", "Sweet potatoes if you want more slow-release carbs."],
    pairsWith: ["powerlifting-peak", "onyx-hypertrophy"],
  },
  {
    slug: "korean-beef-rice-bowl",
    title: "Korean Beef Rice Bowl",
    tagline: "Sweet-savory ground beef over rice with kimchi and a runny egg - 44g protein in 15 minutes.",
    category: "High Protein",
    diets: ["High Protein", "Dairy Free"],
    ...
    summary: "The fastest weeknight protein bomb. Ground beef browned with soy, ginger and sesame, piled over rice with a runny fried egg and spicy kimchi on the side.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      ...
      "3 tbsp soy sauce", "1 tbsp brown sugar", "1 tbsp toasted sesame oil",
      "1 tbsp fresh ginger, grated", "3 garlic cloves, minced", "1 tsp gochugaru or chili flakes",
      "1 cup jasmine rice (dry)", "2 eggs", "1/2 cup kimchi", "Scallions and sesame seeds to finish",
    ]}],
    instructions: [
    ...
    proTips: ["Use 5% fat beef to keep macros clean but not dry.", "Break the yolk into the beef right before eating - the sauce is the whole point."],
    storage: "Beef keeps 4 days refrigerated. Skip the egg for meal prep and fry fresh.",
    swaps: ["Ground turkey or chicken to cut fat further.", "Cauliflower rice for a low-carb version."],
  ...
  },
  {
    ...
    summary: "The one-pan brunch that always looks better than the effort suggests. Eggs poach in a smoky cumin-paprika tomato sauce, feta melts across the top, bread on the side to mop up everything.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "2 tbsp olive oil", "1 onion, diced", "1 red bell pepper, diced",
      "3 garlic cloves, minced", "1 tsp smoked paprika", "1 tsp cumin", "1/2 tsp chili flakes",
      "1 can (400 g) crushed tomatoes", "4 large eggs", "80 g feta, crumbled",
      "Fresh parsley or cilantro", "Crusty sourdough to serve",
    ]}],
    instructions: [
    ...
    proTips: ["Cover the pan - it steams the tops of the eggs without overcooking the bottoms.", "Toast the bread in the leftover sauce for 20 seconds a side - do not skip this."],
    storage: "Best eaten fresh. Sauce alone keeps 4 days; poach fresh eggs into a reheated portion.",
    swaps: ["Chickpeas stirred in for extra protein and to make it a full dinner.", "Vegan feta and skip the eggs for a plant-based shakshuka."],
    pairsWith: ["iron-grace-women-40-plus", "beginner-first-rep"],
  },
  {
    slug: "avocado-toast-poached-eggs",
    title: "Loaded Avocado Toast",
    tagline: "Sourdough, smashed avo, poached eggs, chili crisp - 24g protein and better than a cafe.",
    category: "Breakfast",
    diets: ["High Protein", "Vegetarian"],
    ...
    summary: "Cafe avocado toast without the 18 dollar price tag. Two poached eggs, ripe avocado, sourdough with a proper chewy crust, and a spoon of chili crisp for the kick.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "2 slices thick sourdough", "1 ripe avocado", "2 large eggs", "1 tbsp white vinegar",
      "1 tsp chili crisp or hot sauce", "Salt, pepper, lemon juice", "Microgreens or sprouts",
    ]}],
    instructions: [
    ...
    proTips: ["Older eggs poach worse - use ones under a week old for tight whites.", "A pinch of flaky salt on the yolk right before eating changes everything."],
    storage: "Assemble fresh. Boiled eggs can sub for poached in a meal-prep version.",
    swaps: ["Cottage cheese under the avocado for +12 g protein.", "Gluten-free sourdough works one-for-one."],
    pairsWith: ["fat-loss-blueprint", "iron-grace-women-40-plus"],
  },
  {
    slug: "thai-peanut-chicken-noodles",
    title: "Thai Peanut Chicken Noodles",
    tagline: "Rice noodles tossed in creamy peanut-lime sauce with grilled chicken - 42g protein takeout upgrade.",
    category: "Dinner",
    diets: ["High Protein", "Dairy Free"],
    ...
    summary: "The takeout you keep ordering, done at home for a third the money and double the protein. Rice noodles slicked in a creamy peanut sauce with charred chicken and crunchy peanuts on top.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Bowl", items: ["500 g chicken breast, sliced", "250 g rice noodles", "2 carrots, julienned", "1 red pepper, thin sliced", "1/2 cup cilantro", "1/4 cup crushed peanuts", "2 limes"] },
      { title: "Peanut sauce", items: ["4 tbsp peanut butter", "3 tbsp soy sauce", "2 tbsp lime juice", "2 tbsp honey", "1 tbsp rice vinegar", "1 tbsp grated ginger", "2 garlic cloves", "1 tsp chili flakes", "3-4 tbsp warm water to thin"] },
    ],
    instructions: [
    ...
    proTips: ["Rinse noodles cold to stop cooking and keep them from turning gluey.", "Sauce thickens as it sits - keep extra warm water to loosen leftovers."],
  ...
  },
  {
    ...
    tagline: "Lemon-oregano chicken, tzatziki, cucumber and rice - 48g protein Mediterranean plate.",
    category: "Lunch",
    diets: ["High Protein", "Gluten Free"],
    image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1200&q=80",
    prepTime: 15, cookTime: 12, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 590, protein: 48, carbs: 52, fat: 18 },
    summary: "A deconstructed souvlaki that hits all the same notes: bright lemon chicken, cool creamy tzatziki, crunchy cucumber-tomato salad and warm rice underneath.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Chicken", items: ["500 g chicken thighs, cubed", "3 tbsp olive oil", "3 tbsp lemon juice", "2 tsp dried oregano", "3 garlic cloves, minced", "Salt and pepper"] },
      { title: "Tzatziki", items: ["1 cup Greek yogurt", "1/2 cucumber, grated and squeezed dry", "1 garlic clove, minced", "1 tbsp lemon juice", "1 tbsp chopped dill"] },
      { title: "Bowl", items: ["1 cup basmati rice (dry)", "1 cup cherry tomatoes, halved", "1/2 cucumber, diced", "1/4 red onion, thin sliced", "Kalamata olives", "Crumbled feta (optional)"] },
    ],
    instructions: [
    ...
    proTips: ["Thighs stay juicier than breasts on a grill - worth the tiny fat difference.", "Salt and squeeze the cucumber hard before adding to yogurt or the tzatziki turns watery."],
    storage: "Components refrigerate separately for 4 days. Ideal meal prep - assemble at the office in a minute.",
  ...
  },
  {
    ...
    tagline: "Sweet potato, chickpeas, kale and tahini drizzle - 22g plant protein and every micronutrient.",
    category: "Vegan",
    ...
    summary: "The bowl every plant-based athlete should have on repeat. Roasted sweet potato and crispy chickpeas over quinoa and massaged kale, drenched in lemon tahini.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Bowl", items: ["1 large sweet potato, cubed", "1 can chickpeas, drained and dried", "1 cup dry quinoa", "3 cups kale, stems removed", "1/2 avocado", "2 tbsp pumpkin seeds"] },
      { title: "Tahini drizzle", items: ["3 tbsp tahini", "Juice of 1 lemon", "1 small garlic clove, grated", "1 tsp maple syrup", "3-4 tbsp warm water"] },
      { title: "Spice mix", items: ["2 tbsp olive oil", "1 tsp cumin", "1 tsp smoked paprika", "Salt and pepper"] },
    ],
    instructions: [
    ...
    proTips: ["Dry the chickpeas hard with a towel before roasting or they steam instead of crisping.", "Massaging kale is not optional - raw kale is inedible, massaged kale is a salad."],
    storage: "Components keep 4 days refrigerated. Store tahini separate, thin with water when serving.",
  ...
  },
  {
    ...
    summary: "Actually good protein pancakes - fluffy, sweet, browned crisp on the edges. Blender batter, no protein-powder rubberiness, ready in the time coffee takes to brew.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "1/2 cup rolled oats", "1 scoop vanilla whey (25 g)", "1/2 cup cottage cheese",
      "1 ripe banana", "2 eggs", "1/2 tsp baking powder", "1/2 tsp vanilla", "Pinch of salt",
      "Butter or oil for the pan", "Fresh berries and maple syrup to serve",
    ]}],
    instructions: [
    ...
    proTips: ["Medium-LOW heat - protein pancakes burn fast because of the milk sugars.", "Let batter sit 2 minutes before cooking so the oats hydrate and the stack goes fluffier."],
  ...
  },
  {
    ...
    tagline: "30g casein-heavy protein with berries, honey and granola - 5-minute snack or breakfast.",
    category: "Snacks",
    diets: ["High Protein", "Vegetarian"],
    ...
    summary: "The unsexy snack that is basically ice cream nutritionally. Cottage cheese, drizzled honey, torn berries and crunchy granola on top. Great pre-bed for the slow casein release.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "1 cup (250 g) low-fat cottage cheese", "1/2 cup mixed berries (fresh or thawed)",
      "1 tbsp honey", "1/4 cup crunchy granola", "1 tbsp sliced almonds", "Fresh mint (optional)",
    ]}],
    instructions: [
    ...
    proTips: ["Buy the good full-fat cottage cheese - low-fat versions are watery and taste like nothing.", "Blend the cottage cheese if the curds bother you - texture goes to Greek yogurt smooth."],
    storage: "Prep without granola, hold up to 3 days. Add granola right before eating so it stays crunchy.",
    swaps: ["Skyr or Greek yogurt for a smoother base.", "Peanut butter drizzle instead of honey for a savory-sweet spin."],
    pairsWith: ["fat-loss-blueprint", "iron-grace-women-40-plus"],
  },
  {
    ...
    prepTime: 15, cookTime: 8, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 510, protein: 38, carbs: 48, fat: 18 },
    summary: "Taco Tuesday, upgraded. Shrimp cooked in a chili-lime butter, piled into charred corn tortillas with a crunchy cabbage slaw and avocado - assembly is faster than delivery.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Shrimp", items: ["500 g raw peeled shrimp", "2 tbsp olive oil", "1 tbsp chili powder", "1 tsp smoked paprika", "1 tsp garlic powder", "1 tsp cumin", "Juice of 1 lime", "Salt"] },
      { title: "Slaw", items: ["2 cups shredded red cabbage", "1 carrot, grated", "1/4 cup cilantro", "Juice of 1 lime", "1 tbsp olive oil", "Salt"] },
      { title: "To serve", items: ["8 small corn tortillas", "1 avocado, sliced", "Hot sauce", "Lime wedges"] },
    ],
    instructions: [
    ...
    proTips: ["Buy raw shrimp - the pre-cooked ones turn to rubber when you heat them.", "Double-stack the tortillas - one alone always splits under a real filling."],
    storage: "Shrimp and slaw refrigerate 2 days. Char fresh tortillas each time.",
    swaps: ["Grilled chicken or fish instead of shrimp.", "Lettuce wraps for a true low-carb version."],
    pairsWith: ["shredded-8-week-fat-loss", "fat-loss-blueprint"],
  },
  {
    slug: "lemon-garlic-shrimp-pasta",
    title: "Lemon Garlic Shrimp Pasta",
    tagline: "Bright lemon-butter shrimp over pasta - 40g protein and fresh enough for hot training days.",
    category: "Dinner",
    diets: ["High Protein"],
    image: "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?auto=format&fit=crop&w=1200&q=80",
    prepTime: 5, cookTime: 15, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 600, protein: 40, carbs: 62, fat: 18 },
    summary: "Restaurant-style shrimp scampi at home. Big garlic hit, plenty of lemon, just enough butter to make the pasta glossy. On the table in 20 minutes and clean-tasting enough for hot summer training blocks.",
    whyItWorks: [
    ...
    ingredients: [{ items: [
      "250 g linguine or spaghetti", "500 g raw peeled shrimp",
      "2 tbsp olive oil", "2 tbsp butter", "6 garlic cloves, thin sliced",
      "1/2 tsp chili flakes", "Juice and zest of 1 lemon", "1/2 cup pasta water",
      "1/4 cup parsley, chopped", "Salt, pepper, Parmesan to finish",
    ]}],
    instructions: [
    ...
    proTips: ["Do not brown the garlic - burnt garlic ruins the whole dish. Pull the pan off if it goes too fast.", "Reserved pasta water is what makes the sauce glossy instead of oily - do not skip it."],
    storage: "Best fresh. Leftover keeps 2 days but shrimp toughens on reheat.",
    swaps: ["Whole wheat or chickpea pasta for more fiber and protein.", "Chicken instead of shrimp - just add 3 minutes cook time."],
    pairsWith: ["onyx-hypertrophy", "athlete-mass-blueprint"],
  },
  {
    ...
    summary: "The burger you actually want, built to hit hard macros. Lean beef seared black-and-blue, sharp cheese, pickles, and oven-crisped sweet potato fries on the side.",
    whyItWorks: [
    ...
    ingredients: [
      { title: "Burgers", items: ["400 g 90/10 ground beef", "2 brioche buns", "2 slices cheddar", "Butter lettuce, tomato, red onion, pickles", "Mustard and mayo"] },
      { title: "Fries", items: ["2 large sweet potatoes, cut into fries", "1 tbsp olive oil", "1 tsp cornstarch", "1 tsp smoked paprika", "Salt"] },
    ],
    instructions: [
    ...
    proTips: ["Cornstarch is the trick to actually crispy oven fries - do not skip.", "Do not press the burger with a spatula. All the juice leaves. All of it."],
  ...
  // ============ EXPANDED LIBRARY - REAL PHOTOS ============
  {
    ...
    category: "Dinner", diets: ["High Protein"],
    ...
    summary: "The Sunday-sauce Italian classic, macro-friendly. Lean turkey meatballs baked then finished in a slow-simmered marinara. Serve over pasta, spaghetti squash, or a hunk of bread.",
    whyItWorks: ["Ground turkey delivers 46 g of protein with a fraction of the saturated fat of beef.", "Simmered marinara delivers concentrated lycopene, better absorbed with olive oil.", "Meatballs freeze perfectly, making this the highest ROI meal prep on the list."],
    ingredients: [
      { title: "Meatballs", items: ["700 g ground turkey (93/7)", "1 egg", "1/2 cup panko", "1/4 cup grated Parmesan", "3 garlic cloves, minced", "1 tsp dried oregano", "1 tsp salt, black pepper", "1/4 cup chopped parsley"] },
      { title: "Marinara", items: ["2 tbsp olive oil", "1 onion, diced", "4 garlic cloves, minced", "2 cans (400 g each) crushed tomatoes", "1 tsp sugar", "1 tsp dried basil", "Salt, pepper, chili flakes"] },
    ],
    instructions: [
    ...
    proTips: ["Do not overwork the meat - mix just until combined or the meatballs go rubbery.", "A pinch of sugar in marinara balances tomato acidity - it is not for sweetness."],
  ...
  },
  {
    ...
    tagline: "Grilled chicken, crisp romaine, Caesar and Parmesan in a whole-wheat wrap - 40g protein lunch.",
    category: "Lunch", diets: ["High Protein"],
    ...
    summary: "All the Caesar salad greatness, wrapped and portable. Grilled chicken, cold crunchy romaine, sharp Parmesan and a creamy Greek-yogurt Caesar you will make on repeat.",
    whyItWorks: ["Greek-yogurt Caesar cuts the classic dressing's fat in half without killing the flavor.", "Whole-wheat wrap adds fiber and slow carbs versus a white flour tortilla.", "Chicken breast keeps the whole thing at 40 g protein under 520 kcal."],
    ingredients: [
      { title: "Wraps", items: ["2 large whole-wheat tortillas", "2 grilled chicken breasts, sliced", "3 cups romaine, chopped", "1/3 cup shaved Parmesan", "1/2 cup croutons"] },
      { title: "Caesar", items: ["1/2 cup Greek yogurt", "2 tbsp grated Parmesan", "1 tbsp Dijon", "1 tbsp lemon juice", "2 anchovies, mashed (or 1 tsp Worcestershire)", "1 garlic clove, grated", "Black pepper"] },
    ],
    instructions: [
    ...
    proTips: ["Anchovies vanish flavor-wise but make the Caesar taste real - trust the process.", "Warm the wrap first - it stops the crack that always ruins the first bite."],
  ...
  },
  {
    ...
    category: "Dinner", diets: ["High Protein", "Dairy Free"],
    image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1200&q=80",
    prepTime: 15, cookTime: 0, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 610, protein: 42, carbs: 62, fat: 22 },
    summary: "Hawaiian poke shop energy at home for a fraction of the cost. Marinated raw ahi, sushi rice, edamame, cucumber, avocado and a spicy mayo drizzle over the top.",
    whyItWorks: ["Raw ahi delivers 42 g of protein and long-chain omega-3s in one bowl.", "Sushi rice's stickiness makes bites clean without needing extra sauce.", "Avocado and sesame oil provide the fats that make raw fish satisfying, not sparse."],
    ingredients: [
      { title: "Poke", items: ["350 g sashimi-grade ahi tuna, cubed", "2 tbsp soy sauce", "1 tbsp toasted sesame oil", "1 tsp rice vinegar", "1 tsp grated ginger", "1 scallion, sliced"] },
      { title: "Bowl", items: ["1 cup sushi rice (dry)", "1 cup shelled edamame", "1 avocado, sliced", "1 cucumber, sliced", "1/4 cup pickled ginger", "Sesame seeds, seaweed strips"] },
    ...
    proTips: ["Buy tuna from a real fish counter, tell them it's for raw eating.", "Cube tuna cold - warm tuna smears on the knife and turns to paste."],
  ...
  },
  {
    ...
    tagline: "Sizzling chicken, peppers and onions with warm tortillas - 44g protein family dinner.",
    category: "Dinner", diets: ["High Protein", "Dairy Free"],
    ...
    summary: "The steakhouse fajita moment, at home in 25 minutes. Charred chicken, blistered peppers, sweet onions, warm tortillas and everyone builds their own.",
    whyItWorks: ["High-heat searing builds Maillard flavor without needing heavy sauces.", "Bell peppers deliver over 200% RDA of vitamin C per serving.", "Corn tortillas keep the plate gluten free without cutting carbs too low for training."],
    ingredients: [{ items: ["600 g chicken breast, sliced thin", "3 bell peppers, sliced", "2 large onions, sliced", "2 tbsp olive oil", "2 tsp chili powder", "1 tsp cumin", "1 tsp smoked paprika", "1 tsp garlic powder", "Juice of 1 lime", "Salt and pepper", "8 corn or flour tortillas", "Greek yogurt, salsa, cilantro, lime wedges to serve"]}],
    instructions: [
    ...
    proTips: ["Very hot pan is non-negotiable - a lukewarm skillet steams instead of chars.", "Slice everything the same thickness so it cooks evenly."],
  ...
  },
  {
    ...
    summary: "Weeknight teriyaki that tastes like the takeout spot but hits macros. Salmon glazed sticky-sweet, broccoli charred hard, jasmine rice underneath catching all the sauce.",
    whyItWorks: ["Salmon's omega-3s reduce training-induced inflammation.", "Broccoli's sulforaphane supports liver detox on high-protein weeks.", "Homemade teriyaki has half the sugar of a bottled sauce."],
    ingredients: [{ items: ["2 x 170 g salmon fillets", "1 large head broccoli, in florets", "1 tbsp olive oil", "1 cup jasmine rice", "Sesame seeds and scallion to finish"]}, { title: "Teriyaki", items: ["3 tbsp soy sauce", "2 tbsp mirin", "1 tbsp brown sugar", "1 tsp grated ginger", "1 clove garlic, grated", "1 tsp cornstarch mixed with 2 tbsp water"] }],
    instructions: [
    ...
    proTips: ["Do not stir the teriyaki after adding cornstarch - let it come to a slow bubble to activate.", "Skin-side down first every time - it renders fat and crisps into salmon bacon."],
  ...
  },
  {
    ...
    tagline: "Prep-tonight, eat-tomorrow oats with 28g protein and everything a lifter wants at 7 a.m.",
    category: "Breakfast", diets: ["High Protein", "Vegetarian"],
    image: peanutBananaOats,
    prepTime: 5, cookTime: 0, servings: 1, difficulty: "Easy",
    macrosPerServing: { calories: 480, protein: 28, carbs: 62, fat: 14 },
    summary: "The move for humans who cannot deal with cooking at 6 a.m. Stir it together the night before, wake up to a creamy oat cup that tastes like PB banana ice cream.",
    whyItWorks: ["Overnight soaking makes oat starches easier to digest than cooked versions.", "Chia seeds add omega-3s and 5 g of fiber.", "Milk plus whey doubles up the protein so you actually hit a real breakfast target."],
    ingredients: [{ items: ["1/2 cup rolled oats", "1 cup milk or almond milk", "1 scoop vanilla or PB whey", "1 tbsp chia seeds", "1 tbsp peanut butter", "1 ripe banana, sliced", "1 tsp maple syrup", "Cinnamon"]}],
    instructions: [
    ...
    proTips: ["Use half milk half yogurt for a thicker, creamier result.", "Add whey AFTER soaking if you find it clumps overnight - stir in fresh in the morning."],
  ...
  },
  {
    ...
    category: "Meal Prep", diets: ["High Protein", "Dairy Free"],
    ...
    summary: "Four identical, macro-locked lunch boxes done in 45 minutes. Teriyaki-glazed chicken, jasmine rice, steamed broccoli, sesame seeds - reheats to actually taste good.",
    whyItWorks: ["Chicken thighs stay moist through 4 days of reheating far better than breasts.", "Cool rice quickly and it forms resistant starch - lower glycemic impact when reheated.", "Portioning up front removes the biggest reason people fall off tracking."],
    ingredients: [
      { title: "Boxes", items: ["800 g chicken thighs, cubed", "2 cups jasmine rice (dry)", "2 heads broccoli, florets", "Sesame seeds and scallion"] },
      { title: "Teriyaki", items: ["6 tbsp soy sauce", "3 tbsp mirin", "2 tbsp brown sugar", "1 tbsp grated ginger", "2 garlic cloves", "1.5 tsp cornstarch in 3 tbsp water"] },
    ],
    instructions: [
    ...
    proTips: ["Undercook the broccoli by a minute - it finishes cooking in the microwave.", "Store sauce on the side for boxes eaten day 3 and 4 to keep chicken from getting sticky-dry."],
  ...
  },
  {
    ...
    category: "Lunch", diets: ["High Protein", "Gluten Free", "Dairy Free"],
    image: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1200&q=80",
    prepTime: 10, cookTime: 25, servings: 2, difficulty: "Easy",
    macrosPerServing: { calories: 620, protein: 40, carbs: 58, fat: 24 },
    summary: "The bowl that hits every macro and micronutrient at once. Roasted salmon flaked over warm quinoa, roasted sweet potato, massaged kale and a bright lemon-tahini drizzle.",
    whyItWorks: ["Salmon plus quinoa creates a full amino acid profile with omega-3s built in.", "Sweet potato and kale together cover a full day's vitamin A.", "Tahini contributes calcium and healthy fat for micronutrient completeness."],
    ingredients: [{ items: ["2 x 150 g salmon fillets", "1 cup dry quinoa", "1 large sweet potato, cubed", "3 cups kale, torn", "1 avocado, sliced", "2 tbsp pumpkin seeds"]}, { title: "Dressing", items: ["3 tbsp tahini", "Juice of 1 lemon", "1 tsp maple syrup", "1 small garlic clove", "3-4 tbsp warm water"] }],
    instructions: [
    ...
    proTips: ["Room-temp salmon flakes cleaner - pull it from the fridge 20 minutes before cooking.", "Toast pumpkin seeds in a dry pan 90 seconds to unlock the flavor."],
  ...
  },
  {
    ...
    tagline: "Creamy chocolate oats with 32g protein and real cocoa flavor - hot breakfast in 5 minutes.",
    category: "Breakfast", diets: ["High Protein", "Vegetarian"],
    ...
    summary: "The winter morning fix. Creamy oats cooked in milk, cocoa stirred in, chocolate whey folded off the heat so it doesn't clump. Sliced banana and peanut butter to finish.",
    whyItWorks: ["Cocoa polyphenols support recovery on hard training weeks.", "Rolled oats deliver beta-glucan fiber that keeps hunger flat for hours.", "Adding whey off the heat keeps it creamy instead of rubbery."],
    ingredients: [{ items: ["1/2 cup rolled oats", "1 cup milk of choice", "1 tbsp cocoa powder", "1 scoop chocolate whey (25 g)", "1 tsp maple syrup", "1/2 banana, sliced", "1 tbsp peanut butter", "Pinch of salt"]}],
    instructions: [
    ...
    proTips: ["Whey NEVER goes on active heat - it seizes and turns to concrete.", "Add a splash of milk after adding whey if too thick - protein always dries oats out."],
  ...
  },
  {
    ...
    tagline: "Charred chicken over romaine with Greek-yogurt Caesar - 48g protein, big lunch salad.",
    category: "Lunch", diets: ["High Protein"],
    ...
    summary: "A big salad that eats like a meal. Charred chicken, cold crisp romaine, garlicky croutons, shaved Parmesan, and a Caesar you'll build weekly.",
    whyItWorks: ["48 g protein at under 500 kcal is one of the leanest ratios in the whole library.", "Greek yogurt Caesar cuts calories by 40% without killing the flavor.", "Sourdough croutons add texture and slow carbs without pushing the total up."],
    ingredients: [
      { title: "Salad", items: ["500 g chicken breasts", "3 romaine hearts, chopped", "1/3 cup shaved Parmesan", "1 cup sourdough croutons", "1 tbsp olive oil", "Salt, pepper"] },
      { title: "Caesar", items: ["1/2 cup Greek yogurt", "2 tbsp mayo", "1 tbsp Dijon", "1 tbsp lemon juice", "2 anchovy fillets, mashed", "1 garlic clove, grated", "2 tbsp grated Parmesan"] },
    ],
    instructions: [
    ...
    proTips: ["Pound chicken - even thickness cooks evenly and stays juicy.", "Croutons: toss stale sourdough in olive oil and garlic, bake 10 min at 200 °C."],
  ...
  },
  {
    ...
    category: "Vegan", diets: ["Vegan", "Dairy Free"],
    ...
    summary: "The tofu stir fry that changes people's minds about tofu. Cornstarch-crisped cubes tossed in a sticky sesame-ginger glaze with crunchy snap peas and peppers.",
    whyItWorks: ["Extra-firm tofu delivers 20 g of complete protein per serving.", "Cornstarch coating creates a golden shell that holds the sauce.", "Snap peas keep the meal fiber-heavy and crunchy without adding much prep."],
    ingredients: [{ items: ["400 g extra-firm tofu, pressed and cubed", "3 tbsp cornstarch", "2 tbsp neutral oil", "200 g snap peas", "1 red bell pepper, sliced", "3 scallions", "Cooked rice to serve"]}, { title: "Sauce", items: ["3 tbsp soy sauce", "1 tbsp toasted sesame oil", "1 tbsp maple syrup", "1 tbsp rice vinegar", "1 tbsp grated ginger", "2 garlic cloves", "1 tsp chili flakes"] }],
    instructions: [
    ...
    proTips: ["PRESS the tofu - wet tofu never crisps. Weight it under a heavy pan for 15 minutes.", "Do not move the tofu while it sears - flipping too soon rips the crust off."],
  ...
  },
  {
    ...
    tagline: "Tender flank steak in glossy ginger-garlic sauce over rice - 44g protein takeout upgrade.",
    category: "Dinner", diets: ["High Protein", "Dairy Free"],
    image: "https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=1200&q=80",
    prepTime: 15, cookTime: 10, servings: 3, difficulty: "Moderate",
    macrosPerServing: { calories: 580, protein: 44, carbs: 55, fat: 20 },
    summary: "The classic take-out beef and broccoli, made properly. Velveted flank steak slices, deep-charred broccoli, glossy sauce that clings to every piece. Better than the delivery version, guaranteed.",
    whyItWorks: ["Velveting (a cornstarch-soy marinade) is the trick to steakhouse-tender beef.", "Broccoli's phytonutrients pair perfectly with high-heat cooking.", "Rice is the sauce delivery mechanism - do not skip it."],
    ingredients: [
      { title: "Beef", items: ["500 g flank steak, thin sliced across the grain", "1 tbsp soy sauce", "1 tbsp cornstarch", "1 tsp sesame oil"] },
      { title: "Sauce", items: ["1/3 cup soy sauce", "3 tbsp oyster sauce", "2 tbsp brown sugar", "1 tbsp rice vinegar", "1 tbsp cornstarch", "1/2 cup water"] },
      { title: "Rest", items: ["1 large head broccoli, florets", "3 tbsp neutral oil", "4 garlic cloves, minced", "1 tbsp grated ginger", "Cooked rice"] },
    ],
    instructions: [
    ...
    proTips: ["Slice beef across the grain - long fibers = chewy meat. Angle 45 degrees for tender bites.", "Everything cooks in under 4 minutes at the stove - prep everything before you turn on heat."],
  ...
  },
  {
    ...
    tagline: "Wok-charred shrimp, egg and peas over day-old rice - 38g protein, on the table in 15 minutes.",
    category: "Dinner", diets: ["High Protein", "Dairy Free"],
    ...
    summary: "The perfect leftover-rice rescue. Wok-hot pan, shrimp browned, egg scrambled loose, peas and rice fried until edges crisp and every grain gets a soy-sesame glaze.",
    whyItWorks: ["Day-old rice fries into crispy grains; fresh rice steams into mush.", "Shrimp cooks in 90 seconds - fastest lean protein on Earth.", "Scrambled egg adds another 6 g of protein and richness for basically zero effort."],
    ingredients: [{ items: ["3 cups cold cooked jasmine rice (day old)", "300 g raw peeled shrimp", "3 eggs, beaten", "1 cup frozen peas and carrots", "3 tbsp neutral oil", "3 tbsp soy sauce", "1 tbsp toasted sesame oil", "3 garlic cloves, minced", "3 scallions, sliced", "Salt, white pepper"]}],
    instructions: [
    ...
    proTips: ["Cold rice only - fresh rice makes wet fried rice and it is a war crime.", "Move fast - fried rice is a 4-minute affair once the pan is hot."],
  ...
  },
  {
    ...
    tagline: "Silky hummus, warm pita, olives, cucumber, feta and eggs - 22g protein Mediterranean lunch.",
    category: "Lunch", diets: ["High Protein", "Vegetarian"],
    ...
    summary: "The lunch to build when the fridge looks empty. Silky hummus in the middle, warm pita, hard-boiled eggs, feta, olives, cucumber and tomato around the outside. Grazing food that hits macros.",
    whyItWorks: ["Chickpeas and tahini together give complete plant protein.", "Olive oil and olives supply monounsaturated fats for hormone health.", "Full-fat feta and eggs push total protein to 22 g without needing meat."],
    ingredients: [{ items: ["1 can chickpeas, drained", "3 tbsp tahini", "Juice of 1 lemon", "1 garlic clove", "3 tbsp olive oil", "1/2 tsp cumin, salt", "Ice water to thin"]}, { title: "Plate", items: ["2 warm pita", "4 hard-boiled eggs, halved", "80 g feta", "Kalamata olives", "1 cucumber, sliced", "Cherry tomatoes", "Fresh mint or parsley", "Za'atar or smoked paprika to dust"] }],
    instructions: [
    ...
    proTips: ["Ice water is the secret - it whips air into the hummus and makes it silky.", "Warm the pita in a dry pan 30 sec per side - never cold."],
    storage: "Hummus 5 days refrigerated. Whole plate best assembled fresh.",
    swaps: ["Grilled chicken added for +30 g protein.", "Sweet potato wedges instead of pita for gluten free."],
    pairsWith: ["iron-grace-women-40-plus", "fat-loss-blueprint"],
  },
  {
    ...
    category: "Low Carb", diets: ["High Protein", "Low Carb", "Gluten Free", "Dairy Free"],
    ...
    summary: "All the takeout satisfaction, none of the crash. Cauliflower rice fried hot with diced chicken, egg, peas and a proper soy-sesame hit.",
    whyItWorks: ["Cauliflower rice cuts carbs by 80% versus jasmine rice.", "Chicken breast + 2 eggs stacks 40 g protein at under 400 kcal.", "Peas add fiber and just enough natural sweetness to feel like the real thing."],
    ingredients: [{ items: ["400 g chicken breast, diced small", "600 g cauliflower rice (fresh or frozen thawed)", "2 eggs", "1 cup frozen peas", "3 tbsp soy sauce", "1 tbsp toasted sesame oil", "3 garlic cloves", "1 tbsp grated ginger", "2 tbsp neutral oil", "Scallion and sesame seeds"]}],
    instructions: [
    ...
    proTips: ["Press cauli rice against the pan - it caramelizes and mimics real fried rice.", "Thaw frozen cauli rice fully and squeeze dry or it stays soggy."],
    storage: "3 days refrigerated.",
  ...
  },
  {
    ...
    category: "Vegan", diets: ["Vegan", "Gluten Free", "Dairy Free"],
    ...
    summary: "The one-pot vegan dinner on rotation forever. Warm spices bloomed in oil, tomato, coconut milk, chickpeas and spinach - 25 minutes and the whole kitchen smells like a takeaway.",
    whyItWorks: ["Chickpeas + brown rice cover the essential amino acids.", "Coconut milk supplies MCTs that make plant-based eating actually satisfying.", "Turmeric plus black pepper together boost curcumin's bioavailability massively."],
    ingredients: [{ items: ["2 tbsp coconut oil", "1 onion, diced", "4 garlic cloves, minced", "1 tbsp grated ginger", "2 tsp curry powder", "1 tsp cumin", "1 tsp turmeric", "1/2 tsp chili flakes", "1 can (400 g) crushed tomatoes", "1 can (400 ml) full-fat coconut milk", "2 cans chickpeas, drained", "4 cups baby spinach", "Juice of 1 lime", "Cilantro, cooked basmati rice"]}],
    instructions: [
    ...
    proTips: ["Bloom the spices in oil for a full minute - the whole curry lifts.", "Save half the coconut milk for the last 5 min so it stays creamy not broken."],
  ...
  },
  {
    ...
    tagline: "Skirt steak, charred peppers, lime rice and black beans - 45g protein Chipotle at home.",
    category: "High Protein", diets: ["High Protein", "Gluten Free"],
    ...
    summary: "Chipotle burrito bowl energy in your own kitchen. Charred skirt steak sliced thin, cilantro-lime rice, black beans, blistered peppers, salsa, guac and a squeeze of lime.",
    whyItWorks: ["Skirt steak is packed with iron and creatine - both boost training output.", "Rice plus beans cover all essential aminos even before the steak.", "The lime and cilantro cut the richness so you actually finish the bowl."],
    ingredients: [
      { title: "Steak", items: ["400 g skirt steak", "1 tbsp olive oil", "2 tsp chili powder", "1 tsp cumin", "1 tsp smoked paprika", "Salt"] },
      { title: "Bowl", items: ["1 cup basmati rice", "Juice of 1 lime + 1/4 cup cilantro (for rice)", "1 can black beans, warmed", "2 bell peppers + 1 onion, sliced and charred", "1/2 cup pico de gallo", "1/2 avocado, mashed", "Sour cream or Greek yogurt"] },
    ],
    instructions: [
    ...
    proTips: ["Skirt is thin - overcook by 30 seconds and it turns to shoe leather. Med-rare only.", "Rest steak on a plate not a board - you want to keep those juices."],
  ...
  },
  {
    ...
    category: "Breakfast", diets: ["High Protein"],
    ...
    summary: "The New York cafe breakfast at home for a third the price. Toasted bagel, thick cream cheese, cold-smoked salmon, capers, red onion and dill. Ready in under 5 minutes.",
    whyItWorks: ["Smoked salmon delivers 20 g of protein and omega-3s per serving.", "Everything bagels add fiber and slow carbs to fuel morning training.", "Capers and lemon cut the cream cheese richness perfectly."],
    ingredients: [{ items: ["1 everything bagel", "3 tbsp cream cheese (or whipped cottage cheese)", "80 g cold-smoked salmon", "1 tbsp capers", "2 thin slices red onion", "Fresh dill", "Lemon wedge", "Black pepper"]}],
    instructions: [
    ...
    proTips: ["Toast the bagel dark - a soft toasted bagel loses to the wet toppings.", "Ripple the salmon, don't lay it flat - it looks and eats better."],
    storage: "Assemble fresh. Salmon keeps 4 days sealed.",
    swaps: ["Whipped cottage cheese for lower fat / higher protein.", "Sourdough instead of bagel."],
    pairsWith: ["fat-loss-blueprint", "iron-grace-women-40-plus"],
  },
  {
    slug: "chicken-pesto-pasta-salad",
    title: "Chicken Pesto Pasta Salad",
    tagline: "Cold pasta salad with pesto chicken, sun-dried tomato and mozzarella - 38g protein meal prep.",
    category: "Meal Prep", diets: ["High Protein"],
    ...
    summary: "The best cold lunch prep of the year. Pesto-tossed pasta with grilled chicken, sun-dried tomato, fresh mozzarella pearls and rocket. Better on day 2 than day 1.",
    whyItWorks: ["Cooled pasta forms resistant starch, lower blood sugar impact than reheated.", "Fresh mozzarella pearls add protein and calcium without heaviness.", "Pesto's olive oil aids fat-soluble vitamin absorption from the greens."],
    ingredients: [{ items: ["350 g fusilli or penne", "500 g chicken breast, grilled and sliced", "1/2 cup basil pesto", "1/2 cup sun-dried tomatoes, chopped", "200 g mozzarella pearls", "3 cups rocket", "1/3 cup pine nuts, toasted", "Juice of 1 lemon", "Olive oil, salt, pepper"]}],
    instructions: [
    ...
    proTips: ["Salt the pasta water like the sea - it's the only chance the pasta itself gets seasoned.", "Add rocket in the container instead of tossed if prepping 4 days ahead - it wilts otherwise."],
  ...
  },
  {
    ...
    tagline: "Layered turkey ragu, ricotta and zucchini ribbons - 42g protein, low-carb comfort dinner.",
    category: "Low Carb", diets: ["High Protein", "Low Carb", "Gluten Free"],
    image: "https://images.unsplash.com/photo-1574894709920-11b28e7367e3?auto=format&fit=crop&w=1200&q=80",
    prepTime: 20, cookTime: 40, servings: 6, difficulty: "Moderate",
    macrosPerServing: { calories: 450, protein: 42, carbs: 18, fat: 24 },
    summary: "Lasagna satisfaction without the carb crash. Zucchini ribbons replace the pasta, a slow-simmered turkey ragu handles the flavor, ricotta and mozzarella do the melty work on top.",
    whyItWorks: ["Zucchini strips replace pasta with 90% fewer carbs and add water-soluble vitamins.", "Ground turkey stays lean; ricotta and mozzarella keep it feeling like lasagna.", "The dish reheats better than pasta lasagna because zucchini doesn't turn to slop."],
    ingredients: [
      { title: "Ragu", items: ["700 g ground turkey", "1 onion, diced", "4 garlic cloves, minced", "2 cans (400 g each) crushed tomatoes", "2 tbsp tomato paste", "1 tsp oregano, basil, salt", "1/2 tsp chili flakes"] },
      { title: "Layers", items: ["3 large zucchini, thin lengthwise ribbons", "500 g ricotta", "1 egg", "1/2 cup grated Parmesan", "200 g mozzarella, shredded", "Fresh basil"] },
    ],
    instructions: [
    ...
    proTips: ["Salt-and-drain the zucchini or the lasagna floods with water.", "Rest before slicing or it collapses into slop - hardest part of the recipe."],
