...
export const articles: Article[] = [
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "Progressive overload is the principle that your body adapts to a training stress only when that stress increases over time. The mistake most lifters make is thinking it just means 'add weight to the bar.' Weight is one of at least six variables you can push - and if you only chase load, you'll plateau inside a year." },
          { type: "p", text: "Your body doesn't care about the number on the plate. It cares about how much tension your muscles produced, how close to failure you got, how many hard sets they accumulated across the week, and how repeatable that stimulus was. Load is just one input into that equation." },
          ...
          { type: "quote", text: "You are not stuck. You just stopped pushing the lever that still had room to move.", cite: "Thiago Deschamps" },
        ],
      },
      {
        kicker: "For size",
        ...
        blocks: [
          { type: "p", text: "This is the cleanest hypertrophy method ever invented. Pick a rep range - 8 to 12 is the sweet spot for most lifts. Keep the same weight until you can hit the top of the range on every prescribed set with 1 rep in reserve. Then, and only then, add 2.5 to 5% weight and start the cycle again at the bottom of the range." },
          { type: "callout", title: "Worked example - bench press", text: "80 kg for 3 sets of 8-12. Week 1: 9, 8, 8. Week 2: 10, 9, 8. Week 3: 11, 10, 9. Week 4: 12, 12, 11. Add weight - 82.5 kg for 3 x 8. Repeat. This is boring, undramatic, and adds ~10 kg to your bench per year for a natural lifter. That is the point." },
          { type: "image", src: imgOverloadMid, caption: "Overload is measurable, patient, and boring. That is why it works." },
          { type: "p", text: "The reason double progression beats 'just add weight' is that it self-regulates. On a bad day you don't miss reps - you just log the same weight and try again. On a great day you don't jump too much - you just add reps. The bar moves when you're ready, not when the spreadsheet says so." },
        ],
      },
      {
        kicker: "For strength",
        ...
        blocks: [
          { type: "p", text: "Strength athletes overload differently. Heavy work north of 85% of your one-rep max drains your central nervous system faster than muscle. If you try to add weight every session forever, you will not plateau - you will crash." },
          { type: "p", text: "Waves solve this. You accumulate stress over 3 building weeks, then deload on week 4. Each new wave starts slightly higher than the last, but the deload lets fatigue dissipate before it becomes a hole you can't dig out of." },
          ...
          { type: "p", text: "This is the single most reliable strength-building structure in the world. Every top powerlifter and weightlifter uses some version of it. The math changes, the shape doesn't." },
        ],
      },
      {
        kicker: "The killers",
        ...
        blocks: [
          { type: "p", text: "Programs rarely fail on paper. They fail because a lifter is under-slept, under-fed, and constantly rotating exercises they can't measure. Fix these three before you blame the split." },
          { type: "callout", title: "Sleep", text: "Below 7 hours a night, strength on heavy days drops measurably inside a week. Cold, dark room. No screens 60 min before bed. Same wake time on weekends. The weekend sleep-in does not fix Tuesday's deficit." },
          { type: "callout", title: "Protein", text: "Below 1.6 g/kg of body weight per day, muscle protein synthesis is capped. Aim for 1.8-2.2 g/kg split across 3-5 meals. This is not optional for a lifter." },
          { type: "callout", title: "Exercise rotation", text: "You cannot progressively overload a lift you swap out every 2 weeks. Lock your main lifts (squat, bench, deadlift, overhead press, one pull variation, one hinge) for 8-12 weeks minimum. Rotate accessories, never the anchors." },
        ],
      },
      {
        kicker: "The wrap",
        ...
        blocks: [
          { type: "p", text: "Progressive overload is not a hack. It is a decade-long compounding habit. Push one lever at a time. Measure it. Sleep on it. Eat for it. When one lever stops moving, push a different one for a block before you force it." },
          { type: "p", text: "The lifters who look genetically gifted 10 years in are the ones who did the boring version of this for 10 years. That is the entire trick." },
        ],
      },
    ],
    takeaways: [
  ...
  },
  {
    ...
    title: "Athlete Nutrition Foundations: Protein, Carbs and the Meals That Actually Move You Forward",
    category: "Nutrition",
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "Every credible study on hypertrophy and recovery in the last decade lands in the same place: 1.6 to 2.2 grams of protein per kilogram of body weight, per day, split across 3 to 5 meals. Below that range, you leave gains on the table. Above it, no extra benefit. It is one of the tightest ranges in sports science." },
          { type: "p", text: "A 80 kg lifter needs 130-175 g daily. That's roughly 30-40 g per meal, four times a day. Not complicated - just consistent." },
          ...
          { type: "quote", text: "Nobody has ever failed at building muscle because their food wasn't 'clean' enough. Thousands have failed because they didn't hit their protein.", cite: "Simen Christiansen" },
          { type: "callout", title: "Why split it across meals", text: "Muscle protein synthesis peaks for about 3 hours after a protein feeding, then returns to baseline. Hitting 30-40 g every 3-4 hours keeps the signal on all day. One 150 g steak at dinner doesn't - most of that protein is oxidised for energy instead of building tissue." },
        ],
      },
      {
        kicker: "Macro 2",
        ...
        blocks: [
          { type: "p", text: "Carbs are not the enemy. For a training athlete, they refill muscle glycogen, drive high-intensity output, protect your hormones, and let you recover between sessions. Going low-carb 'to lean out' is a tax on your training quality, and usually a tax you don't need to pay." },
          { type: "image", src: imgNutritionMid, caption: "Real athlete meals: protein, starch, colour, and enough on the plate to train hard tomorrow." },
          ...
          { type: "callout", title: "The workout window", text: "Pre-training: 40-80 g of easy carbs (oats, fruit, rice, rice cakes) 60-90 min before you lift. Post-training: 50-100 g with your protein meal inside 2 hours. This is where most of your daily carbs should land." },
        ],
      },
      {
        kicker: "Macro 3",
        ...
        blocks: [
          { type: "p", text: "Set dietary fat at 0.8-1.2 g/kg minimum. Push below that for more than a few weeks and hormones start to slide - testosterone, thyroid, menstrual cycle regularity for female athletes." },
          { type: "p", text: "Prioritise omega-3 rich sources: salmon, sardines, walnuts, extra-virgin olive oil, chia and flax. If you don't eat fatty fish twice a week, a 2 g EPA + DHA supplement earns its price." },
          { type: "p", text: "Micronutrients come from food, not pills. Aim for four colours on the plate every day - leafy greens, berries, peppers, citrus, tomatoes, carrots. Most lifters also under-eat fibre. Target 30-40 g a day for digestion and gut health." },
        ],
      },
      {
        kicker: "The template",
        ...
        blocks: [
          { type: "p", text: "Forget weighing every gram forever. Build every plate with your hands as the ruler:" },
          { type: "list", items: [
          ...
          { type: "p", text: "Build four of those a day. Hit your protein. The rest is noise. This one template covers 90% of what your body needs to train hard, recover, and grow." },
          { type: "callout", title: "The 20% rule", text: "Pizza, ice cream, beer, birthday cake - eat what you love, roughly 20% of the time. Diets that don't leave room for these fail inside 6 months. Diets that do work for decades. Adherence beats perfection every single time." },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "There is no supplement, protocol, or piece of tech that comes close to sleep. Seven hours is a floor. Eight is the goal. Below seven, growth hormone drops, testosterone drops, insulin sensitivity tanks, and measurable strength on heavy days falls inside 4-5 days." },
          { type: "image", src: imgRecoveryMid, caption: "The most anabolic thing in the room is a dark, cool bedroom and a locked screen." },
          ...
          { type: "quote", text: "You cannot out-train, out-supplement, or out-caffeinate a sleep deficit. Sleep is the training program.", cite: "Lars Lie" },
        ],
      },
      {
        kicker: "Pillar 2",
        ...
        blocks: [
          { type: "p", text: "Your nervous system cannot tell the difference between a heavy deadlift, an argument with your boss, three coffees on an empty stomach, and a bad night's sleep. They all draw from the same recovery account, and that account is finite." },
          { type: "p", text: "This is why 'the exact same program' produces gains one month and plateaus the next. The program didn't change - your life did." },
          { type: "callout", title: "The 20-30% rule", text: "When life stress spikes - work deadline, poor sleep week, illness, big travel - cut training volume by 20-30% for that week. Keep intensity, cut the number of sets. You come back stronger than if you'd forced through and dug a 6-week hole." },
        ],
      },
      {
        kicker: "Pillar 3",
        ...
        blocks: [
          { type: "p", text: "'Rest day' does not mean 'couch day.' Blood flow is what clears metabolic waste and shuttles nutrients into damaged tissue. Sitting on the couch does very little of either. Walking, gentle mobility, and easy cardio do a lot." },
          ...
          { type: "p", text: "Zone 2 is the single most underused tool in strength sports. It drops resting heart rate, improves work capacity, and makes your heavy days feel easier without stealing recovery from them." },
        ],
      },
      {
        kicker: "Pillar 4",
        ...
        blocks: [
          { type: "p", text: "Total daily food matters most. But within that, two windows carry disproportionate weight for recovery: the 2 hours after training, and the meal before bed." },
          { type: "callout", title: "Post-training (within 2 hours)", text: "30-50 g of protein plus 50-100 g of carbs. This is when muscle glycogen replaces fastest and muscle protein synthesis is most sensitive. Rice + chicken + veg + a piece of fruit is enough - no fancy shake required." },
          { type: "callout", title: "Pre-bed", text: "A slow-digesting protein - Greek yogurt, cottage cheese, or casein - gives a slow amino acid drip while you sleep. Small edge, but a real one over months and years of hypertrophy work." },
        ],
      },
      {
        ...
        blocks: [
          { type: "p", text: "Every 4 to 6 weeks, take a planned deload week. Half the volume, keep the movements, drop intensity 15-20%. This is not weakness - it is what lets you train hard for the next 12 months instead of the next 6." },
          { type: "p", text: "The lifters who never deload are the same lifters who take 4-8 unplanned weeks off every year with a tweaked back, elbow, or knee. Choose which 'week off' you'd rather have." },
        ],
      },
    ],
    takeaways: [
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "The deadlift is not an explosive lift. It is a precise lift executed with intent. The setup takes 6-8 seconds and locks in every mechanical advantage your body has. Rush it and you leak force everywhere. Own it and the pull becomes a formality." },
          ...
          { type: "callout", title: "The slack pull", text: "This is the most under-taught detail in the sport. Before you initiate the lift, pull up on the bar with just enough force to remove the play between the bar and the plates. Now every ounce of force you produce goes straight into moving weight instead of taking up slack. This alone adds 5-10 kg to most people's max on day one." },
          { type: "quote", text: "The bar doesn't come off the floor until the setup tells it to. If your setup is wrong, no amount of trying harder fixes the pull.", cite: "Thiago Deschamps" },
        ],
      },
      {
        kicker: "The pull",
        ...
        blocks: [
          { type: "p", text: "The most common failure mode is yanking the bar. Your hips shoot up, your back rounds, and the lift becomes a stiff-leg deadlift with a rounded spine. That is how backs get hurt." },
          { type: "p", text: "Instead, think push. Push the floor away with your legs while keeping your chest facing forward, not down. The bar should break the floor smoothly, not jerk off it. If it jerks, your slack was still in the bar." },
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "Once the bar passes the knees, the lift becomes a hip extension. The quads have done their job. Now the glutes and hamstrings drive the hips forward under the bar until you are standing tall." },
          { type: "p", text: "Do NOT hyperextend at the top. Do NOT lean back. A proper lockout is: knees straight, hips fully extended, glutes squeezed, ribs stacked over pelvis. Standing tall with the bar. Nothing more." },
          { type: "callout", title: "The controlled negative", text: "Every rep gets lowered under control - not dropped, not slammed. Hinge the hips back first, then bend the knees once the bar clears them. Two seconds down. This is where 40% of your hypertrophy stimulus lives, and it teaches you the exact reverse of the setup for the next rep." },
        ],
      },
      {
        kicker: "Common mistakes",
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "The deadlift responds best to lower volume, higher intensity, and religious technical practice. You cannot 'bodybuild' a deadlift up the way you can a squat. It is a skill lift as much as a strength lift." },
          { type: "list", items: [
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "A safe, strong bench uses five points of contact: both feet flat on the floor, glutes on the bench, upper back on the bench, and head on the bench. Lose any one of them mid-rep and the lift becomes unstable and dangerous." },
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "The most common mistake in the bench press is treating the descent as recovery time. It is not. The eccentric is where you build the stretch reflex, groove the bar path, and set up a powerful drive off the chest." },
          { type: "list", items: [
          ...
          { type: "quote", text: "The bar comes down at your speed. The moment it dictates the speed, you have already lost the lift.", cite: "Lars Lie" },
        ],
      },
      {
        kicker: "The press",
        ...
        blocks: [
          { type: "p", text: "Off the chest, drive the feet into the floor - not to lift the hips off the bench, but to create a rigid chain from the ground through the upper back into the bar. This is leg drive. Done right it feels like a slingshot." },
          { type: "p", text: "As the bar rises, it travels back toward the shoulders - not straight up. Ending directly over the shoulders puts the load in the strongest mechanical position for lockout." },
          { type: "callout", title: "The exhale", text: "Beginners exhale on the way up. Strong benchers exhale AFTER lockout. Air pressure inside a braced core is what keeps the ribcage rigid and the arch supported. Bleed it out at the bottom and the whole structure collapses." },
        ],
      },
      {
        kicker: "Common mistakes",
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "The lift begins before you unrack. J-hooks should sit so the bar is roughly at mid-sternum height when you're standing tall. Too high and you tiptoe out. Too low and you burn a quarter-squat of energy just clearing the rack." },
          ...
          { type: "callout", title: "The walkout", text: "Unrack with a full brace, take 2-3 short steps back, plant your feet, and don't fidget. Every extra step you take wastes energy and shifts your setup. Watch a world-class squatter: they walk it out in 3 steps, take one breath, and squat. That is the standard." },
        ],
      },
      {
        ...
        blocks: [
          ...
          { type: "callout", title: "The 360° brace", text: "Take a huge breath into your belly - not your chest. Feel your obliques and lower back push out against a belt or your waistband. This creates intra-abdominal pressure, the single most important spine-protection mechanism you have. Hold the breath through the entire rep. Exhale only at lockout." },
          { type: "quote", text: "You cannot squat heavy weights with a weak brace. The brace is not optional. It is the lift.", cite: "Simen Christiansen" },
        ],
      },
      {
        kicker: "The descent",
        ...
        blocks: [
          { type: "p", text: "The most common cue in the gym - 'sit back' - is only half right. Sit back too much and you turn a squat into a good morning. Sit straight down and your knees track over your toes but you fold at the hips." },
          { type: "p", text: "The correct feeling: sit BETWEEN your hips. Break at the hips and knees at the same time. Push the knees out over the pinky toes as you descend. Your torso will lean forward - that's fine and correct. Keep the bar directly over the midfoot the entire way down." },
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "Out of the hole, the mistake is letting the hips shoot up first. Your torso pitches forward, the squat becomes a good morning, and your lower back becomes the primary mover of a heavy weight. Fix it with a single cue: 'chest up as you drive'. The hips and shoulders should rise at exactly the same rate." },
          { type: "list", items: [
