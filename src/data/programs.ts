...
export const warmupByCategory: Record<ProgramCategory, WarmupBlock> = {
  Strength: {
    intro: "Strength sessions live or die on the warm-up. The goal is a hot CNS, lubricated joints, and crisp movement patterns before the first working set. Total time: 10-12 minutes.",
    generalPrep: [
      { name: "Easy bike or row", detail: "Zone 1, nasal breathing only, raise core temperature without fatigue.", duration: "3-4 min" },
      { name: "World's greatest stretch", detail: "Hip flexor, T-spine rotation, hamstring sweep - 3 reps per side.", duration: "1 min" },
      { name: "Cat-camel + dead bug", detail: "Spine segmentation then 6 slow dead bugs to lock the brace.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "Empty bar x 8 reps", detail: "Groove the exact pattern of the first main lift, perfect bar path.", duration: "1 set" },
      { name: "Ramping sets", detail: "Add 10-20 kg at a time, 3-5 reps, until ~85% of working weight. Last warm-up is a single.", duration: "4-6 sets" },
    ],
    activation: [
      { name: "Band pull-apart", detail: "20 reps to wake the upper back before pressing or pulling.", duration: "2 sets" },
      { name: "Glute bridge or hip airplane", detail: "10 reps each side - fires glutes for squat/deadlift day.", duration: "2 sets" },
    ],
    rules: [
  ...
  Powerlifting: {
    intro: "Heavy singles demand a deliberate, ramped warm-up. The aim is full neural drive without burning sets. Total time: 12-15 minutes.",
    generalPrep: [
      { name: "Bike, sled, or jump rope", detail: "Light pace, get a thin sweat. Heart rate ~120 bpm.", duration: "4 min" },
      { name: "90/90 hip switch + ankle rocks", detail: "Open the hips and ankles for squat depth.", duration: "1 min" },
      { name: "T-spine foam roll", detail: "60 seconds on the upper back - critical for bench arch and bar position on squats.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "Bar x 10", detail: "Two empty bar sets, then start ramping.", duration: "2 sets" },
      { name: "Pyramid up", detail: "40% x 5, 60% x 3, 75% x 2, 85% x 1, 92% x 1 - then first work set.", duration: "5 sets" },
    ],
    activation: [
      { name: "Banded good morning", detail: "15 reps to load the posterior chain on squat/deadlift day.", duration: "2 sets" },
      { name: "Scap push-up + face pull", detail: "10 + 15 reps to stabilize the shoulder on bench day.", duration: "2 sets" },
    ],
    rules: [
  ...
  Strongman: {
    intro: "Strongman days blend maximal loading with odd-object work and locomotion. Warm the whole body, then rehearse the implements. Total time: 12-15 minutes.",
    generalPrep: [
      { name: "Sled drag (light)", detail: "2 lengths of 20 m, easy pace, raise core temperature and prime the hips.", duration: "3 min" },
      { name: "Hip flow + T-spine opener", detail: "90/90, cossack, thoracic reach.", duration: "2 min" },
    ],
    specificPrep: [
      { name: "Empty implement rehearsal", detail: "Log, axle, or yoke - 2 reps at the empty weight to groove the path.", duration: "2 sets" },
      { name: "Ramp to opener", detail: "40 → 60 → 75 → 88% before the first working set / carry.", duration: "4 sets" },
    ],
    activation: [
      { name: "Farmer carry (light)", detail: "20 m at 40% load - fires grip, traps, and midline.", duration: "2 sets" },
      { name: "Banded pull-apart", detail: "20 reps to prepare the upper back for pressing and carrying.", duration: "2 sets" },
    ],
    rules: [
  ...
  Hypertrophy: {
    intro: "For hypertrophy the warm-up should drive blood into the target tissue and rehearse the mind-muscle connection - not exhaust it. Total time: 8-10 minutes.",
    generalPrep: [
      { name: "Cross-trainer or rower", detail: "Easy pace, raise temperature without lactate.", duration: "3 min" },
      { name: "Dynamic mobility circuit", detail: "Arm circles, scap CARs, hip CARs - 10 reps each.", duration: "2 min" },
    ],
    specificPrep: [
      { name: "Feeder sets", detail: "2 light sets at 40-50% of working weight, slow tempo, focus on stretch and squeeze.", duration: "2 sets" },
      { name: "Primer set", detail: "First working set stopped 3 reps shy of failure - second set is the real opener.", duration: "1 set" },
    ],
    activation: [
      { name: "Pre-exhaust isolation", detail: "Lateral raises before pressing, cable curl before back, leg extension before squats - 15 light reps.", duration: "1 set" },
    ],
    rules: [
  ...
  Bodybuilding: {
    intro: "Bodybuilding warm-ups are about quality reps, not heat. Wake the target muscle, rehearse the path, then attack the working sets. Total time: 8-10 minutes.",
    generalPrep: [
      { name: "Stair climber or incline walk", detail: "Light pace, nasal breathing, raise temperature.", duration: "3 min" },
      { name: "Foam roll target area", detail: "30-60 seconds on the muscle being trained today.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "2 ramp sets per first exercise", detail: "50% x 10 then 70% x 6 with a 3-second eccentric - feel every rep.", duration: "2 sets" },
    ],
    activation: [
      { name: "Mind-muscle primer", detail: "Lightest possible variation (band, cable) x 20 reps, deliberate squeeze at peak.", duration: "1 set" },
    ],
    rules: [
  ...
  "Fat Loss": {
    intro: "On a deficit your joints, tendons and CNS are more fragile. A real warm-up protects everything you've built while priming you to push intensity. Total time: 8 minutes.",
    generalPrep: [
      { name: "Steady cardio", detail: "Bike, row or jog at zone 1 - get the engine spinning.", duration: "3 min" },
      { name: "Dynamic full-body flow", detail: "Inchworm, lunge with rotation, scap push-up - 5 reps each.", duration: "2 min" },
    ],
    specificPrep: [
      { name: "Movement rehearsal", detail: "First exercise with bodyweight or empty bar x 10 - perfect tempo.", duration: "1 set" },
      { name: "Ramp to working weight", detail: "60% x 8, 80% x 5 before the first hard set.", duration: "2 sets" },
    ],
    activation: [
      { name: "Glute and core pulse", detail: "Glute bridge x 15 + dead bug x 10 to lock the brace under fatigue.", duration: "1 set" },
    ],
    rules: [
  ...
  Endurance: {
    intro: "Running and conditioning warm-ups must raise temperature, open the hips and ankles, and rehearse stride mechanics. Total time: 10 minutes.",
    generalPrep: [
      { name: "Brisk walk into easy jog", detail: "Start walking, gradually transition to an easy aerobic jog.", duration: "5 min" },
      { name: "Leg swings + ankle circles", detail: "10 each direction per leg.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "Form drills", detail: "A-skips, B-skips, butt kicks, high knees - 20 m of each.", duration: "3 min" },
      { name: "Strides", detail: "4 × 60-80 m at ~80% of top speed with full recovery walk back.", duration: "3 min" },
    ],
    activation: [
      { name: "Single-leg glute bridge", detail: "10 reps per side to stabilize the hip before loaded miles.", duration: "1 set" },
    ],
    rules: [
  ...
  Hyrox: {
    intro: "Hyrox sessions blend heavy carries, sleds and running - the warm-up must prep ALL three. Total time: 12 minutes.",
    generalPrep: [
      { name: "Row 500 m easy", detail: "Steady pace, target around 2:15/500m. Get the engine warm.", duration: "2 min" },
      { name: "Dynamic flow", detail: "Inchworm, lunge with twist, scap push-up, squat to stand - 5 each.", duration: "3 min" },
    ],
    specificPrep: [
      { name: "Sled push primer", detail: "Empty sled or light load x 20 m - practice low athletic position.", duration: "2 sets" },
      { name: "Wall ball x 10", detail: "Light medicine ball, rehearse squat depth and target.", duration: "1 set" },
      { name: "Burpee broad jump x 5", detail: "Half intensity - wake the hips and shoulders.", duration: "1 set" },
    ],
    activation: [
      { name: "Glute bridge + band pull-apart", detail: "15 + 20 reps to fire posterior chain and upper back.", duration: "2 sets" },
    ],
    rules: [
  ...
  "Home Training": {
    intro: "No gym, no excuses - but no warm-up means injury. Body-weight prep elevates temperature and grooves patterns in 8 minutes.",
    generalPrep: [
      { name: "Jumping jacks + high knees", detail: "30 seconds each, 2 rounds.", duration: "2 min" },
      { name: "Inchworm to push-up", detail: "5 reps, slow and controlled.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "Bodyweight squat x 10", detail: "Slow tempo, full depth, hands overhead.", duration: "2 sets" },
      { name: "Push-up x 8", detail: "Knees if needed - perfect plank position.", duration: "2 sets" },
    ],
    activation: [
      { name: "Glute bridge + bird dog", detail: "15 + 10 per side, lock the brace.", duration: "1 set" },
    ],
    rules: [
  ...
  Women: {
    intro: "Designed around female physiology - extra time on hips, T-spine, and pelvic floor activation to support every lift. Total time: 10 minutes.",
    generalPrep: [
      { name: "Incline walk or bike", detail: "Easy pace, build a light sweat.", duration: "4 min" },
      { name: "90/90 hip switch", detail: "10 per side, focus on internal rotation.", duration: "1 min" },
      { name: "T-spine open book", detail: "8 per side - frees the upper back for pressing.", duration: "1 min" },
    ],
    specificPrep: [
      { name: "Empty bar / light DB rehearsal", detail: "10 reps of the first lift, full range of motion.", duration: "2 sets" },
      { name: "Ramp set", detail: "60% of working weight x 5 with a 2-second pause at the bottom.", duration: "1 set" },
    ],
    activation: [
      { name: "Glute bridge + clamshell", detail: "15 + 12 per side. Fires glute medius before squats and lunges.", duration: "2 sets" },
      { name: "Pelvic floor breathing", detail: "5 slow breaths - exhale on the lift to coordinate the brace.", duration: "1 min" },
    ],
    rules: [
  ...
  Beginner: {
    intro: "Beginners need MORE warm-up, not less - patterns aren't grooved yet. This 10-minute protocol builds skill while it warms.",
    generalPrep: [
      { name: "Easy bike or brisk walk", detail: "Just enough to feel warm - no fatigue.", duration: "4 min" },
      { name: "World's greatest stretch", detail: "3 per side, slow and controlled.", duration: "2 min" },
    ],
    specificPrep: [
      { name: "Movement rehearsal", detail: "Bodyweight version of every lift in today's session, 8 reps each.", duration: "3 min" },
      { name: "Empty bar / light DB ramp", detail: "10 reps at 50% of working weight before each main lift.", duration: "1 set" },
    ],
    activation: [
      { name: "Glute bridge + dead bug", detail: "10 reps each - these two moves prevent 80% of beginner back pain.", duration: "1 set" },
    ],
    rules: [
    ...
    faqs: [
      {
        ...
        answer: "Yes, but expect strength to plateau. Keep volume the same and reduce intensity techniques in the last 3 weeks.",
      },
      {
        question: "What if I miss a session?",
        answer: "Push it to the next day and shift the rest of the week back. Don't double up - recovery is the variable that grows you.",
      },
    ],
  },
  {
    ...
    workouts: [
      {
        ...
        focus: "Max strength",
        exercises: [
          { name: "Back Squat", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8 on final set)", rest: "3 min" },
      ...
      },
      {
        ...
        focus: "Bench + triceps",
        exercises: [
          { name: "Barbell Bench Press", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8 on final set)", rest: "3 min" },
      ...
      },
      {
        ...
        exercises: [
          { name: "Deadlift", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8 on final set)", rest: "3 min" },
    ...
    faqs: [
      {
        ...
        answer: "Yes. RPE autoregulates loads to how recovered you actually are, which is far more honest than a fixed percentage.",
      },
    ],
  },
  {
    ...
    workouts: [
      ...
      },
      {
        ...
        exercises: [
          { name: "- Superset A · 3 rounds (do both exercises back-to-back, then rest 60 sec, repeat 3x)", sets: "", reps: "", rest: "" },
          { name: "Incline Dumbbell Press", sets: "3", reps: "12", rest: "10 sec" },
          { name: "Dumbbell Row", sets: "3", reps: "12/side", rest: "60 sec" },
          { name: "- Superset B · 3 rounds (do both exercises back-to-back, then rest 60 sec, repeat 3x)", sets: "", reps: "", rest: "" },
          { name: "Cable Chest Fly", sets: "3", reps: "15", rest: "10 sec" },
          { name: "Cable Face Pull", sets: "3", reps: "15", rest: "45 sec" },
          { name: "- Arm Finisher · 3 rounds (do both exercises back-to-back, then rest 45 sec, repeat 3x)", sets: "", reps: "", rest: "" },
      ...
      },
      {
        ...
        exercises: [
          { name: "- Complex A · 5 rounds (all 4 moves in a row = 1 round, rest 90 sec after, repeat 5x)", sets: "", reps: "", rest: "" },
      ...
      },
      {
        ...
        exercises: [
          { name: "Assault Bike Intervals", sets: "4", reps: "60 sec hard / 60 sec easy", rest: "-" },
    ...
    faqs: [
      {
        ...
        answer: "A commercial gym makes it easier, but every session has dumbbell-only substitutions inside the Onyx app.",
      },
      {
        question: "Why do Weeks 3-8 look like Weeks 1-2?",
        answer: "The plan runs a 2-week rotation on purpose. W3 = W1 + progressive overload, W4 = W2 + progressive overload, and so on. Same movements, heavier loads, shorter rests - that's how fat-loss training actually works.",
      },
    ],
  },
  {
    ...
    recovery: "Two rest days per week. Walking on rest days speeds recovery without taxing the joints.",
    trainingOverview:
      "Upper / Lower / Conditioning / Full Body, repeated weekly. Tempo and unilateral work make light dumbbells feel heavy.",
    progression: "Add one rep per set per week. Week 4 swaps to slower tempos. Week 6 retests reps at week-1 weights.",
    weeklySchedule: [
    ...
    faqs: [
      {
        ...
        answer: "One light pair (10-20 lb) and one moderate pair (25-40 lb) covers everything. Adjustables work even better.",
      },
    ],
  },
  {
    ...
    progression: "Add one rep per set weekly. After 4 weeks, add a set to your top exercise. Deload at week 5, repeat through week 10.",
    weeklySchedule: [
    ...
    faqs: [
      {
        ...
        answer: "Yes. Merge Day 5 and Day 6 into a single weak-point + pump session and take Sunday off.",
      },
    ],
  },
  {
    ...
    trainingOverview: "Three full-body days alternating between Workout A and Workout B every other session.",
    progression: "Add 5 lb to lower-body lifts and 2.5 lb to upper-body lifts every session until a failed rep. Then deload 10% and continue.",
    weeklySchedule: [
    ...
    faqs: [
      {
        ...
        answer: "Box squat to a bench, then progressively lower the box. Mobility comes with practice.",
      },
    ],
  },
];
...
// ------------------------------------------------------------
type NewProg = Partial<Program> & Pick<Program, "slug" | "title" | "tagline" | "category" | "level" | "duration" | "daysPerWeek" | "goal" | "image" | "summary" | "weeklySchedule" | "workouts">;
...
const buildProgram = (p: NewProg): Program => {
  ...
  return {
    ...
    nutrition: "Hit a daily protein target of 0.8-1 g per pound of bodyweight, anchor meals around whole-food carbs, and stay within ±300 kcal of the goal (surplus, maintenance or deficit) for the duration of the block.",
    supplementation: "Creatine monohydrate (5 g/day), a quality whey or plant protein to backfill daily protein, electrolytes around training, and vitamin D3 + magnesium for recovery.",
    recovery: "Sleep 7-9 hours, walk 8-10k steps/day, protect one true rest day, and reduce intensity any week sleep or stress fall off a cliff.",
    trainingOverview: "Sessions pair the highest-return compound from the Onyx library with focused accessory work. Volume rises in waves and deloads on schedule so nothing breaks down.",
    progression: "Weeks 1-2 build technique and baseline loads. Mid-block (weeks 3-5) progressively overload top sets. Final weeks intensify, then deload + retest in the closing week.",
    faqs: [
      {
        question: "Can I move sessions around to fit my schedule?",
        answer: "Yes - keep the order of training days but swap which calendar day they land on. Avoid stacking the two hardest sessions back-to-back.",
      },
      {
        question: "What if I miss a workout?",
        answer: "Slide the week back by one day rather than doubling up. Recovery is the variable that creates progress.",
      },
    ],
    includes: [
...
const freeSamplers: Program[] = [
  buildProgram({
    ...
    summary: "A full-body intro week built on the squat, bench, deadlift and row. Use it to learn the Onyx programming style before committing to the full 8-week plan.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Full Body A", focus: "Squat focus", exercises: [
      ...
      { day: "Day 2", title: "Full Body B", focus: "Hinge focus", exercises: [
      ...
      { day: "Day 3", title: "Full Body C", focus: "Overhead + lunge", exercises: [
  ...
  buildProgram({
    ...
    image: programBodybuilding,
    summary: "Three sessions of classic Push / Pull / Legs work pulled from the Onyx library. A quick taste of the 10-week Classic Physique program.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Push", focus: "Chest / Shoulders / Triceps", exercises: [
        { name: "Incline Barbell Press", sets: "4", reps: "8", rest: "2 min" },
        { name: "Flat Dumbbell Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Cable Lateral Raise", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Overhead Rope Triceps", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 2", title: "Pull", focus: "Back / Biceps", exercises: [
      ...
      { day: "Day 3", title: "Legs", focus: "Quad + posterior", exercises: [
  ...
  buildProgram({
    ...
    summary: "Four sessions hitting each main lift with a strength and a volume exposure - the same pattern the full 12-week Raw Power block uses.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Heavy Squat", focus: "Squat + posterior chain", exercises: [
        { name: "Back Squat", sets: "5", reps: "5 (add weight when all 5 sets complete)", rest: "3 min" },
        { name: "Goblet Squat", sets: "3", reps: "6", rest: "2 min" },
        { name: "Romanian Deadlift", sets: "3", reps: "8", rest: "2 min" },
        { name: "Bulgarian Split Squat", sets: "3", reps: "8 / leg", rest: "90 sec" },
      ]},
      { day: "Day 2", title: "Heavy Bench", focus: "Bench + upper body pressing", exercises: [
        { name: "Barbell Bench Press", sets: "5", reps: "5 (add weight when all 5 sets complete)", rest: "3 min" },
        { name: "Incline Dumbbell Press", sets: "3", reps: "8", rest: "2 min" },
        { name: "Close-Grip Bench Press", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Chest Fly", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 4", title: "Heavy Deadlift", focus: "Pull + back thickness", exercises: [
        { name: "Deadlift", sets: "4", reps: "5 (build to top set of 5 across sets)", rest: "3 min" },
      ...
      { day: "Day 5", title: "Volume Bench", focus: "Pump + shoulders", exercises: [
  ...
  buildProgram({
    ...
    image: programFatloss,
    summary: "One strength day, one conditioning circuit, one full-body finisher. Built to drop body fat without losing the muscle you've earned.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Upper Strength", focus: "Push/Pull", exercises: [
        { name: "Barbell Bench Press", sets: "4", reps: "6", rest: "2 min" },
        { name: "Lat Pull Down", sets: "4", reps: "8", rest: "90 sec" },
        { name: "Seated Dumbbell Shoulder Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Face Pulls", sets: "3", reps: "15", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Conditioning A", focus: "Engine + grip", exercises: [
        { name: "Assault Bike Intervals", sets: "8", reps: "20 sec on / 40 sec off", rest: "-" },
        { name: "Farmer Carry", sets: "4", reps: "40 m", rest: "60 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "10", rest: "45 sec" },
      ]},
      { day: "Day 4", title: "Lower Strength", focus: "Squat + hinge", exercises: [
        { name: "Back Squat", sets: "4", reps: "6", rest: "3 min" },
        { name: "Romanian Deadlift", sets: "3", reps: "8", rest: "2 min" },
        { name: "Walking Lunge", sets: "3", reps: "10/side", rest: "90 sec" },
        { name: "Bicycle Crunches Easy", sets: "3", reps: "20/side", rest: "45 sec" },
      ]},
      { day: "Day 5", title: "Full Body Finisher", focus: "Density circuit", exercises: [
  ...
  buildProgram({
    ...
    summary: "A mixed-modal week pulled directly from our Hyrox prep block: running intervals, sled work, rowing pieces and core stability.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Run + Sled + Row", focus: "Single-pass stations, move in order, rest as listed", exercises: [
      ...
      { day: "Day 2", title: "Strength", focus: "Race-specific · straight sets", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Back Squat", sets: "4", reps: "5 @ RPE 7 (add load if last set feels ≤ RPE 6)", rest: "2 min" },
      ...
      { day: "Day 3", title: "Row + Burpees + Wall Balls", focus: "Single-pass stations, move in order", exercises: [
        { name: "Rowing Machine (500 m @ ~2:00/500 m pace)", sets: "1", reps: "500 m", rest: "2 min" },
        { name: "Burpee Broad Jump", sets: "3", reps: "10", rest: "90 sec" },
      ...
      { day: "Day 5", title: "Compromised Running (Race Sim)", focus: "For Time · complete in order, rest only where listed", exercises: [
  ...
  buildProgram({
    ...
    summary: "One easy run, one tempo, one long run and a runner-specific strength session - the exact pattern of the 8-week 5K build.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Mon", title: "Strength for Runners", focus: "Single-leg base", exercises: [
      ...
      { day: "Tue", title: "Easy Run + Strides", focus: "Zone 2 aerobic", exercises: [
        { name: "Treadmill Run (Zone 2)", sets: "1", reps: "30 min (conversational pace)", rest: "-" },
        { name: "Strides", sets: "6", reps: "20 sec (near full sprint)", rest: "60 sec easy jog" },
      ]},
      { day: "Wed", title: "Mobility / Full Rest", focus: "Recovery", exercises: [
        { name: "Treadmill Walk", sets: "1", reps: "20-30 min", rest: "-" },
        { name: "Hip / Calf Mobility", sets: "1", reps: "10 min", rest: "-" },
      ]},
      { day: "Thu", title: "Tempo Run", focus: "Threshold", exercises: [
        { name: "Treadmill Run (warm-up)", sets: "1", reps: "10 min", rest: "-" },
        { name: "Treadmill Run (Zone 3-4)", sets: "1", reps: "20 min (comfortably hard)", rest: "-" },
        { name: "Treadmill Run (cooldown)", sets: "1", reps: "10 min", rest: "-" },
      ]},
      { day: "Fri", title: "Rest Day", focus: "Full recovery", exercises: [
        { name: "Treadmill Walk", sets: "1", reps: "20 min", rest: "-" },
      ]},
      { day: "Sat", title: "Long Run", focus: "Endurance · Zone 2", exercises: [
        { name: "Treadmill Run (Zone 2)", sets: "1", reps: "40-50 min (conversational pace)", rest: "-" },
      ]},
      { day: "Sun (Optional)", title: "Recovery Walk", focus: "Optional · skip if tired", exercises: [
  ...
  buildProgram({
    ...
    goal: "Train anywhere",
    image: programBeginner,
    summary: "Four short, dense sessions you can run from a bedroom or garage - pulled straight from the Garage Built 6-week block.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
      { day: "Monday", session: "Upper Body Dumbbell" },
    ...
    workouts: [
      { day: "Day 1", title: "Upper Body Dumbbell", focus: "Push/Pull", exercises: [
      ...
      { day: "Day 2", title: "Lower + Bands", focus: "Glutes + quads", exercises: [
      ...
      { day: "Day 4", title: "Conditioning Circuit", focus: "EMOM 20 min", exercises: [
        { name: "Burpees", sets: "5", reps: "10", rest: "-" },
        { name: "Goblet Squat", sets: "5", reps: "12", rest: "-" },
        { name: "Push Ups", sets: "5", reps: "12", rest: "-" },
        { name: "Reverse Crunch", sets: "5", reps: "15", rest: "-" },
      ]},
      { day: "Day 5", title: "Full Body", focus: "Strength", exercises: [
        { name: "Goblet Squat", sets: "4", reps: "8", rest: "90 sec" },
  ...
  buildProgram({
    ...
    summary: "Three glute-priority leg days (squat, hip thrust, glute pump) drive the whole week. Two shorter upper-body days keep the body balanced without stealing recovery. Every leg day ends on the stair machine, and the weekend is a light core + walk session.",
    progression: "This single week is the on-ramp. Every glute main lift stays @ RPE 7 (3 reps in reserve) so you can groove the pattern and squeeze hard at the top. Stop every set 2-3 reps shy of failure. If any main lift feels ≥ RPE 9, hold the same load next time. The full 8-week glute specialization runs the full 3-week wave (RPE 7 → 8 → 9) with a Week 4 deload.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Squat Day (Machines) + Stair Finisher", focus: "Main squat + quad/glute machines", exercises: [
        ...
        { name: "Glute Kickbacks on Machine", sets: "3", reps: "15/side (pause 1 sec at top)", rest: "60 sec" },
        ...
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 10 min steady (level 5-7) · Advanced 15 min (level 8-10, no rails)", rest: "2 min between sets" },
      ]},
      { day: "Day 2", title: "Back + Biceps + Core (short)", focus: "Quick pull day - in and out", exercises: [
      ...
      { day: "Day 3", title: "Glute-Focused Leg Day (Hip Thrust)", focus: "Posterior chain + hinge", exercises: [
        { name: "- Band activation -", sets: "", reps: "", rest: "" },
        { name: "Banded Side Steps", sets: "2", reps: "15/side", rest: "30 sec" },
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Glute Hip Thrusts on Bench", sets: "4", reps: "8 · see weekly plan (2-sec squeeze at top)", rest: "2-3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Romanian Deadlift", sets: "4", reps: "10", rest: "2 min" },
        { name: "Single Leg Body Weight Glute Hip Thrusts", sets: "3", reps: "10/leg", rest: "60 sec" },
        { name: "Glute Kickbacks on Machine", sets: "3", reps: "12/side", rest: "45 sec" },
        { name: "Banded Side Steps", sets: "3", reps: "15/side", rest: "45 sec" },
        { name: "- Optional core -", sets: "", reps: "", rest: "" },
        { name: "Hanging Leg Raise", sets: "3", reps: "10", rest: "45 sec" },
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 8 min easy (level 4-6) · Advanced 12 min (level 7-9)", rest: "2 min between sets" },
      ]},
      { day: "Day 4", title: "Chest + Shoulders + Triceps (short)", focus: "Quick upper push", exercises: [
      ...
      { day: "Day 5", title: "Glute Pump Day + Stair Finisher", focus: "High-volume glute isolation", exercises: [
        { name: "- Band activation -", sets: "", reps: "", rest: "" },
        { name: "Banded Side Steps", sets: "3", reps: "20/side", rest: "30 sec" },
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Glute Hip Thrusts", sets: "4", reps: "12 · see weekly plan (slow 3-sec eccentric)", rest: "90 sec" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Smith Machine Reverse Lunge", sets: "3", reps: "10/leg (long stride)", rest: "75 sec" },
        { name: "Single Leg Body Weight Step Ups", sets: "3", reps: "12/leg (deep, push through heel)", rest: "60 sec" },
        { name: "Glute Kickbacks on Machine", sets: "4", reps: "15/side", rest: "45 sec" },
        { name: "Body Weight Glute Hip Thrusts", sets: "3", reps: "20 (squeeze glutes hard)", rest: "45 sec" },
        { name: "Banded Side Steps", sets: "3", reps: "20/side (burnout)", rest: "30 sec" },
        { name: "- Optional core -", sets: "", reps: "", rest: "" },
        { name: "Kneeling Cable Crunch", sets: "3", reps: "15", rest: "45 sec" },
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 12 min steady (level 5-7) · Advanced 15-20 min intervals (2 min steady / 1 min side steps, level 8-10)", rest: "2 min between sets" },
      ]},
      { day: "Day 6", title: "Core + Stair Climber", focus: "Midline + easy conditioning", exercises: [
        { name: "- Core circuit -", sets: "", reps: "", rest: "" },
        { name: "Plank", sets: "3", reps: "45 sec", rest: "45 sec" },
        { name: "Side Plank", sets: "3", reps: "30 sec/side", rest: "30 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 15 min Zone 2 (level 4-6, conversational) · Advanced 25 min Zone 2 (level 6-8)", rest: "2 min between sets" },
      ]},
      { day: "Day 7", title: "Optional Walk", focus: "Recovery + steps", exercises: [
        { name: "Treadmill Incline Walking", sets: "1", reps: "30-45 min at 5-8% incline, easy pace", rest: "-" },
      ]},
  ...
  buildProgram({
    ...
    summary: "Four-day upper/lower block anchored on the four kings: Barbell Bench Press on bench day, Barbell Back Squat on squat day, Barbell Deadlift on deadlift day and Standing Military Press on shoulder day. Chest+shoulders+triceps share the push day, back+biceps share the pull day. This one-week sampler opens at RPE 7 to groove technique. Optional weekend arms + core if fresh, full rest if not.",
    progression: "This sampler week keeps every main lift @ RPE 7 (3 reps in reserve). Stop each set with clean technique and 2-3 reps left in the tank. If any main lift feels ≥ RPE 9, hold the same load next time. This is the on-ramp, the full 5/3/1 or Upper/Lower 12-week program handles the deload wave after Week 3.",
    recovery: "Sleep 7-9 h, keep Wednesday and Sunday as true rest days, and skip Saturday's optional arms day entirely if any main lift moved slower than expected. The optional day is a bonus, never mandatory.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      // ---------------- WEEK 1 · RPE 7 (groove) ----------------
      { day: "Week 1 · Day 1", title: "Upper A · Bench Day", focus: "Barbell Bench Press top set + upper push", exercises: [
      ...
      { day: "Week 1 · Day 2", title: "Lower A · Squat Day", focus: "Barbell Back Squat top set + quad work", exercises: [
        { name: "- Main lift · Week 1 @ RPE 7 -", sets: "", reps: "", rest: "" },
      ...
      { day: "Week 1 · Day 3", title: "Upper B · Overhead Day", focus: "Standing Military Press + heavy pulling", exercises: [
        { name: "- Main lift · Week 1 @ RPE 7 -", sets: "", reps: "", rest: "" },
      ...
      { day: "Week 1 · Day 4", title: "Lower B · Deadlift Day", focus: "Barbell Deadlift top set + hamstrings", exercises: [
        { name: "- Main lift · Week 1 @ RPE 7 -", sets: "", reps: "", rest: "" },
        { name: "Barbell Deadlift", sets: "4", reps: "3 @ RPE 7 (cut a rep if the bar slows)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Week 1 · Day 5", title: "Optional Arms + Core", focus: "Skip if any main lift was ≥ RPE 8 this week", exercises: [
  ...
  buildProgram({
    ...
    image: programMuscle,
    summary: "Classic bodybuilding-style hypertrophy split: chest+shoulders+triceps together, back+biceps together, plus a leg day and an optional weekend pump session. Heavy on machines, cables and dumbbells - built to grow.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Chest + Shoulders + Triceps", focus: "Push - machines & dumbbells", exercises: [
        { name: "- Main press -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 2", title: "Back + Biceps", focus: "Pull - width + thickness", exercises: [
        { name: "- Main pull -", sets: "", reps: "", rest: "" },
        { name: "Lat Pulldown Wide Grip", sets: "4", reps: "10", rest: "90 sec" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 3", title: "Legs + Glutes", focus: "Squat + hip thrust", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Optional Arms + Shoulders Pump", focus: "Skip if fatigued", exercises: [
  ...
  buildProgram({
    ...
    image: programPowerlifting,
    summary: "Four sessions built around strongman staples: yoke-style squats, overhead pressing, deadlift + stone work, and a sled/carry medley. Chest+shoulders share the pressing day, back+biceps share the pull day, and an optional grip session closes the week.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Heavy Lower + Yoke Carry", focus: "Squat + loaded carry", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 2", title: "Overhead + Chest + Shoulders", focus: "Log/overhead pressing", exercises: [
        { name: "- Main press -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 3", title: "Deadlift + Back + Biceps", focus: "Hinge + heavy pulling", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Sled + Grip Medley", focus: "Carry + conditioning", exercises: [
      ...
      { day: "Day 5", title: "Optional Grip + Core", focus: "Skip if fatigued", exercises: [
        { name: "Dead Hang", sets: "3", reps: "45 sec", rest: "60 sec" },
...
const morePremium: Program[] = [
  buildProgram({
    ...
    summary: "An 8-week mixed-modal block targeting every Hyrox station - sled push/pull, sandbag lunges, wall balls, burpee broad jumps and 1 km runs - alongside the strength base needed to hold pace.",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Run Intervals + Sled", focus: "Lactate threshold", exercises: [
      ...
      { day: "Day 2", title: "Hyrox Strength", focus: "Lunge + carry", exercises: [
      ...
      { day: "Day 3", title: "Row + Burpee Couplet", focus: "Engine · 6 rounds for pace", exercises: [
      ...
      { day: "Day 4", title: "Long Easy Run", focus: "Zone 2 aerobic base", exercises: [
        { name: "Treadmill Run (Zone 2, nasal-only if possible)", sets: "1", reps: "45-60 min", rest: "-" },
        { name: "Treadmill Incline Walk (cool-down)", sets: "1", reps: "5-10 min at 6% incline", rest: "-" },
      ]},
      { day: "Day 5", title: "Race Sim (mini)", focus: "Compromised running", exercises: [
        { name: "Treadmill Run", sets: "1", reps: "1 km", rest: "-" },
  ...
  buildProgram({
    ...
    summary: "Five focused sessions Monday to Friday - Push, Pull, Legs, Push, Pull with a second leg exposure baked in. Dumbbell and machine-heavy so joints stay happy and the stretch is loaded. Weekends are optional arms + core or full rest.",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Push A - Chest Focus", focus: "Incline dumbbell + stretch flyes", exercises: [
      ...
      { day: "Day 2", title: "Pull A - Back Width", focus: "Vertical pulling + lats", exercises: [
        { name: "Lat Pull Down", sets: "4", reps: "10", rest: "90 sec" },
      ...
      { day: "Day 3", title: "Legs A - Quad Focus", focus: "Heavy barbell squat + machine mass", exercises: [
      ...
      { day: "Day 4", title: "Push B - Shoulder Focus", focus: "Overhead + dumbbell pump", exercises: [
        { name: "Seated Dumbbell Shoulder Press", sets: "4", reps: "8", rest: "2 min" },
      ...
      { day: "Day 5", title: "Pull B - Back Thickness + Hamstrings", focus: "Rows, hinge, curls", exercises: [
      ...
      { day: "Day 6", title: "Optional: Arms + Core Pump", focus: "Skip if fatigued - keep it light", exercises: [
  ...
  buildProgram({
    ...
    tagline: "Smith machine, hip thrusts and Bulgarian split squats - full glute build with optional upper days.",
    category: "Women",
    level: "Intermediate",
    duration: "8 Weeks",
    daysPerWeek: 4,
    ...
    workouts: [
      { day: "Day 1", title: "Glute + Leg Day A - Hip Thrust Priority", focus: "Heavy hip thrust + posterior chain", exercises: [
        { name: "- Band activation -", sets: "", reps: "", rest: "" },
        { name: "Banded Side Steps", sets: "2", reps: "20/side", rest: "30 sec" },
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Hip Thrust", sets: "4", reps: "8 · see weekly plan (2-sec squeeze at top)", rest: "2-3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Romanian Deadlift", sets: "4", reps: "10", rest: "2 min" },
        { name: "Smith Machine Reverse Lunge", sets: "3", reps: "10/leg", rest: "90 sec" },
        { name: "Seated Leg Curl", sets: "3", reps: "12", rest: "60 sec" },
        ...
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 10 min steady (level 5-7, no rails) · Advanced 15 min (level 8-10)", rest: "2 min between sets" },
      ]},
      { day: "Day 2", title: "Optional: Back + Biceps + Core", focus: "Light pull day, skip if fatigued", exercises: [
      ...
      { day: "Day 3", title: "Glute + Leg Day B - Squat & Bulgarian", focus: "Smith squat + split squat priority", exercises: [
        { name: "- Band activation -", sets: "", reps: "", rest: "" },
        { name: "Banded Side Steps", sets: "2", reps: "20/side", rest: "30 sec" },
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        ...
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Treadmill Incline Walking", sets: "1", reps: "10 min at 10-12% incline", rest: "-" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 8 min steady (level 4-6) · Advanced 12 min (level 7-9, no rails)", rest: "2 min between sets" },
      ]},
      { day: "Day 4", title: "Optional: Chest + Shoulders + Triceps", focus: "Light push day, skip if fatigued", exercises: [
        { name: "Dumbbell Bench Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Seated Dumbbell Shoulder Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Dumbbell Lateral Raise", sets: "3", reps: "15", rest: "45 sec" },
        { name: "Cable Tricep Pushdown", sets: "3", reps: "12", rest: "45 sec" },
      ...
      { day: "Day 5", title: "Smith Machine Glute Pump Day", focus: "High-volume Smith work + kickbacks", exercises: [
        { name: "- Band activation -", sets: "", reps: "", rest: "" },
        { name: "Banded Side Steps", sets: "3", reps: "20/side", rest: "30 sec" },
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Smith Machine Reverse Lunge", sets: "4", reps: "12/leg · see weekly plan (long stride, push through heel)", rest: "90 sec" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Smith Machine Hip Thrust", sets: "4", reps: "12 (slow eccentric)", rest: "90 sec" },
        { name: "Smith Machine Bulgarian Split Squat", sets: "3", reps: "10/leg", rest: "75 sec" },
        { name: "Cable Glute Kickback", sets: "4", reps: "15/side", rest: "45 sec" },
        { name: "Hip Abduction Machine", sets: "3", reps: "20 (drop set on last)", rest: "45 sec" },
        { name: "Banded Side Steps", sets: "3", reps: "25/side (burnout)", rest: "30 sec" },
        { name: "- Optional core -", sets: "", reps: "", rest: "" },
        { name: "Kneeling Cable Crunch", sets: "3", reps: "15", rest: "45 sec" },
        { name: "- Finisher -", sets: "", reps: "", rest: "" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 10 min steady (level 5-7) · Advanced 15 min intervals (2 min steady / 1 min side steps, level 8-10)", rest: "2 min between sets" },
      ]},
      { day: "Day 6", title: "Optional Core + Stair Climber", focus: "Midline + easy conditioning", exercises: [
        { name: "Kneeling Cable Crunch", sets: "3", reps: "15", rest: "45 sec" },
        { name: "Side Plank", sets: "3", reps: "30 sec/side", rest: "30 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
        { name: "Stair Climber", sets: "Beginner 1 · Advanced 2", reps: "Beginner 15 min Zone 2 (level 4-6) · Advanced 25 min Zone 2 (level 6-8)", rest: "2 min between sets" },
      ]},
    ],
  }),
  buildProgram({
    ...
    image: programRunning,
    summary: "Five running days plus two short strength sessions. Long runs build to 32 km, with weekly tempo and interval work to lift threshold pace.",
    weeklySchedule: [
      { day: "Monday", session: "Strength for Runners" },
    ...
    workouts: [
      { day: "Day 1", title: "Strength for Runners", focus: "Single-leg", exercises: [
        { name: "Goblet Squat", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Romanian Deadlift", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Walking Lunge", sets: "3", reps: "12/side", rest: "60 sec" },
        { name: "Standing Calf Raise", sets: "4", reps: "15", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Intervals", focus: "VO2 max · 800 m repeats", exercises: [
      ...
      { day: "Day 3", title: "Easy Run", focus: "Zone 2 aerobic base", exercises: [
        { name: "Treadmill Run (Zone 2, conversational)", sets: "1", reps: "40-50 min", rest: "-" },
      ]},
      { day: "Day 4", title: "Tempo Run", focus: "Lactate threshold · comfortably hard", exercises: [
        { name: "Warm-Up Jog", sets: "1", reps: "10 min easy", rest: "-" },
        { name: "Treadmill Run (Zone 4)", sets: "1", reps: "25-35 min at threshold pace", rest: "-" },
        { name: "Cool-Down Jog", sets: "1", reps: "10 min easy", rest: "-" },
      ]},
      { day: "Day 6", title: "Long Run", focus: "Endurance build · adds 1-2 km per week", exercises: [
        { name: "Treadmill Run (Zone 2)", sets: "1", reps: "90-150 min at conversational pace", rest: "-" },
        { name: "Treadmill Walk (cool-down)", sets: "1", reps: "5-10 min flat", rest: "-" },
      ]},
      { day: "Day 7", title: "Recovery Run / Walk", focus: "Blood flow · nothing hard", exercises: [
        { name: "Treadmill Walk or Very Easy Run", sets: "1", reps: "20-30 min at Zone 1", rest: "-" },
      ]},
    ],
  }),
  buildProgram({
    ...
    summary: "Three heavy strength sessions plus two conditioning days. Built for lifters who already train and want a longer, smarter cut without losing muscle.",
    weeklySchedule: [
      { day: "Monday", session: "Upper Strength" },
      { day: "Tuesday", session: "Conditioning A" },
    ...
    workouts: [
      ...
      { day: "Day 2", title: "Conditioning A", focus: "Bike + carries", exercises: [
        { name: "Assault Bike Intervals", sets: "10", reps: "20 sec on / 40 off", rest: "-" },
        { name: "Farmer Carry", sets: "5", reps: "40 m", rest: "60 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
      ]},
      { day: "Day 3", title: "Lower Strength", focus: "Squat + hinge", exercises: [
      ...
      { day: "Day 5", title: "Full Body Strength", focus: "Compound circuit · protect muscle in a deficit", exercises: [
        { name: "Trap Bar Deadlift (or Barbell Deadlift)", sets: "4", reps: "5 @ RPE 7-8", rest: "2 min" },
      ...
      { day: "Day 6", title: "Conditioning B", focus: "Sled + rope density · 20 min AMRAP", exercises: [
        { name: "- 20 min AMRAP · rest as needed between rounds -", sets: "", reps: "", rest: "" },
  ...
  buildProgram({
    ...
    summary: "Ten weeks built around your meet date. Hypertrophy block, intensity block, peak week and rehearsal singles at meet attempts.",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Squat (Heavy)", focus: "Ramp to a hard top set of 3", exercises: [
        { name: "Back Squat", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8.5 on final set)", rest: "3 min" },
        { name: "Front Squat", sets: "3", reps: "5", rest: "2 min" },
        { name: "Walking Lunge", sets: "3", reps: "10 / leg", rest: "90 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Bench (Heavy)", focus: "Bench top set + comp accessories", exercises: [
        { name: "Barbell Bench Press", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8.5 on final set)", rest: "3 min" },
        { name: "Spoto Press", sets: "3", reps: "5", rest: "2 min" },
        { name: "Close-Grip Bench Press", sets: "3", reps: "6", rest: "2 min" },
        { name: "Overhead Rope Triceps", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 4", title: "Deadlift (Heavy)", focus: "Pull + back", exercises: [
        { name: "Deadlift", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8.5 on final set)", rest: "3 min" },
        { name: "Pause Deadlift", sets: "3", reps: "3", rest: "2 min" },
        { name: "Barbell Row", sets: "4", reps: "6", rest: "2 min" },
        { name: "Weighted Pull Up", sets: "3", reps: "6", rest: "90 sec" },
        { name: "Back Extension", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 5", title: "Bench (Volume)", focus: "Volume + shoulders", exercises: [
...
const extraPremium: Program[] = [
  ...
  buildProgram({
    ...
    category: "Beginner", level: "Beginner", duration: "6 Weeks", daysPerWeek: 4, goal: "General fitness + technique",
    image: programBeginnerBodyweightAsset.url,
    summary: "Six weeks of progressive bodyweight training that prepares you to walk into any gym and actually lift. Push-up, squat, hinge and pull patterns taught from scratch.",
    weeklySchedule: [
      { day: "Monday", session: "Push + Core" }, { day: "Tuesday", session: "Lower" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Pull + Carry" }, { day: "Friday", session: "Full Body Flow" },
      { day: "Saturday", session: "Walk 30 min" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Push + Core", exercises: [
      ...
      { day: "Day 3", title: "Pull + Carry", focus: "Back and grip using bodyweight only", exercises: [
        { name: "Superman Hold", sets: "3", reps: "20 sec", rest: "45 sec" },
        { name: "Reverse Snow Angels (floor)", sets: "3", reps: "12", rest: "45 sec" },
        { name: "Bodyweight Row (under a sturdy table or low bar)", sets: "4", reps: "8-10", rest: "60 sec" },
        { name: "Y-Raise (prone, floor)", sets: "3", reps: "12", rest: "45 sec" },
        { name: "Bear Crawl", sets: "3", reps: "20 m forward + 20 m back", rest: "60 sec" },
        { name: "Dead Bug", sets: "3", reps: "10/side", rest: "45 sec" },
      ]},
      { day: "Day 4", title: "Full Body Flow", focus: "Movement quality · continuous circuit", exercises: [
  ...
  buildProgram({
    ...
    category: "Beginner", level: "Beginner", duration: "8 Weeks", daysPerWeek: 3, goal: "Master the big 5 lifts",
    image: programBeginnerFullbodyAsset.url,
    summary: "Three full-body sessions per week, alternating workout A and B. Add weight every single session you can - that's the entire program.",
    weeklySchedule: [
      { day: "Monday", session: "Workout A" }, { day: "Tuesday", session: "Rest" }, { day: "Wednesday", session: "Workout B" },
      { day: "Thursday", session: "Rest" }, { day: "Friday", session: "Workout A" }, { day: "Saturday", session: "Walk" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Workout A", exercises: [
        { name: "Back Squat", sets: "3", reps: "5", rest: "3 min" },
        { name: "Barbell Bench Press", sets: "3", reps: "5", rest: "2-3 min" },
        { name: "Barbell Row", sets: "3", reps: "5", rest: "2 min" },
      ]},
      { day: "Day 3", title: "Workout B", exercises: [
        { name: "Back Squat", sets: "3", reps: "5", rest: "3 min" },
        { name: "Overhead Press", sets: "3", reps: "5", rest: "2-3 min" },
        { name: "Deadlift", sets: "1", reps: "5", rest: "-" },
      ]},
  ...
  buildProgram({
    ...
    category: "Bodybuilding", level: "Intermediate", duration: "8 Weeks", daysPerWeek: 5, goal: "Pure muscle gain",
    image: programUpperLowerMass,
    summary: "Upper/lower split with an extra arms day. Each compound is paired with high-quality isolation work in the 8-15 rep range.",
    weeklySchedule: [
      { day: "Monday", session: "Upper Heavy" }, { day: "Tuesday", session: "Lower Heavy" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Upper Pump" }, { day: "Friday", session: "Lower Pump" }, { day: "Saturday", session: "Arms + Calves" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Upper Heavy", exercises: [
      ...
      { day: "Day 2", title: "Lower Heavy", exercises: [
        { name: "- Main lift · heavy -", sets: "", reps: "", rest: "" },
        { name: "Barbell Back Squat", sets: "5", reps: "5 @ RPE 8-9", rest: "3 min" },
      ...
      { day: "Day 4", title: "Upper Pump", exercises: [
      ...
      { day: "Day 5", title: "Lower Pump", exercises: [
      ...
      { day: "Day 6", title: "Arms + Calves", exercises: [
  ...
  buildProgram({
    ...
    category: "Strongman", level: "Intermediate", duration: "10 Weeks", daysPerWeek: 4, goal: "Build max strength + odd-object capacity",
    image: programPowerlifting,
    summary: "Two heavy barbell days plus two dedicated events days. Sled push/pull, farmer carries, log press and stone-to-shoulder work drive the specific capacity that no bodybuilding split can build.",
    weeklySchedule: [
      { day: "Monday", session: "Heavy Lower + Yoke" }, { day: "Tuesday", session: "Overhead + Carry" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Deadlift + Stone" }, { day: "Friday", session: "Sled + Grip Medley" }, { day: "Saturday", session: "Rest / Mobility" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Heavy Lower + Yoke", exercises: [
        { name: "Back Squat", sets: "5", reps: "3 (ramp: light → RPE 7 → RPE 8 on final set)", rest: "3 min" },
        { name: "Front Squat", sets: "3", reps: "5", rest: "2 min" },
      ...
      { day: "Day 2", title: "Overhead + Carry", exercises: [
        { name: "Overhead Press (log or axle)", sets: "5", reps: "3 (ramp to RPE 8 top set)", rest: "3 min" },
        { name: "Push Press", sets: "3", reps: "5", rest: "2 min" },
        { name: "Farmer Carry (heavy)", sets: "4", reps: "20 m", rest: "2 min" },
        { name: "Chest-Supported Row", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Cable Lateral Raise", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 4", title: "Deadlift + Stone", exercises: [
      ...
      { day: "Day 5", title: "Sled + Grip Medley", exercises: [
  ...
  buildProgram({
    ...
    category: "Powerlifting", level: "Intermediate", duration: "9 Weeks", daysPerWeek: 4, goal: "Add 10-20 kg to your total",
    image: programPowerliftingRpeAsset.url,
    summary: "Top sets called by RPE so you never grind a bad day. Volume backoffs drive the hypertrophy that keeps the strength coming.",
    weeklySchedule: [
      { day: "Monday", session: "Squat + Accessories" }, { day: "Tuesday", session: "Bench (Heavy)" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Deadlift + Back" }, { day: "Friday", session: "Bench (Volume)" }, { day: "Saturday", session: "Rest" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Squat + Accessories", exercises: [
        { name: "Back Squat", sets: "4", reps: "5 (ramp: light → RPE 7 → RPE 8 on top set, then 3 backoffs matching load)", rest: "3 min" },
        { name: "Pause Squat", sets: "3", reps: "5", rest: "2 min" },
        { name: "Bulgarian Split Squat", sets: "3", reps: "8 / leg", rest: "90 sec" },
        { name: "Leg Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Standing Calf Raise", sets: "3", reps: "15", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Bench (Heavy)", exercises: [
        { name: "Barbell Bench Press", sets: "4", reps: "5 (ramp to RPE 8 top set, then 3 backoffs)", rest: "3 min" },
        { name: "Close-Grip Bench Press", sets: "3", reps: "6", rest: "2 min" },
        { name: "Incline Dumbbell Press", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Chest-Supported Row", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Overhead Rope Triceps", sets: "3", reps: "12", rest: "60 sec" },
      ]},
      { day: "Day 4", title: "Deadlift + Back", exercises: [
      ...
      { day: "Day 5", title: "Bench (Volume)", exercises: [
        { name: "Barbell Bench Press", sets: "5", reps: "8 @ RPE 7", rest: "2 min" },
        { name: "Seated Dumbbell Shoulder Press", sets: "4", reps: "10", rest: "90 sec" },
        { name: "Dumbbell Lateral Raise", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Cable Chest Fly", sets: "3", reps: "12", rest: "60 sec" },
  ...
  buildProgram({
    ...
    category: "Hypertrophy", level: "Intermediate", duration: "8 Weeks", daysPerWeek: 5, goal: "Lean tissue + range",
    image: programStretchHypertrophy,
    summary: "Every session leads with the lengthened-position variation (deficit RDL, incline curl, overhead triceps) for the strongest hypertrophy stimulus.",
    weeklySchedule: [
      { day: "Monday", session: "Chest + Triceps" }, { day: "Tuesday", session: "Back + Biceps" }, { day: "Wednesday", session: "Legs" },
      { day: "Thursday", session: "Shoulders + Arms" }, { day: "Friday", session: "Posterior Chain" }, { day: "Saturday", session: "Rest" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Chest + Triceps", focus: "Lengthened-position pressing and stretch flyes", exercises: [
        { name: "Incline Dumbbell Press (deep stretch at bottom)", sets: "4", reps: "8-10 @ RPE 8", rest: "2 min" },
        { name: "Flat Dumbbell Press", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Cable Chest Fly (low to high, deep stretch)", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Pec Deck Machine", sets: "3", reps: "12", rest: "60 sec" },
        { name: "Overhead Rope Triceps (elbows overhead)", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Skull Crusher (behind head)", sets: "3", reps: "10", rest: "60 sec" },
      ]},
      { day: "Day 2", title: "Back + Biceps", focus: "Lat stretch on every set", exercises: [
        { name: "Lat Pulldown (dead-hang stretch each rep)", sets: "4", reps: "10 @ RPE 8", rest: "2 min" },
        { name: "Chest-Supported Row Machine", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Straight-Arm Cable Pulldown (long lever)", sets: "3", reps: "12", rest: "60 sec" },
        { name: "Incline Dumbbell Curl (arms hanging, stretched)", sets: "4", reps: "10", rest: "60 sec" },
        { name: "Cable Bicep Curl (behind the body)", sets: "3", reps: "12", rest: "45 sec" },
        { name: "Face Pull", sets: "3", reps: "15", rest: "45 sec" },
      ]},
      { day: "Day 3", title: "Legs", focus: "Squat below parallel, hip flexion emphasis", exercises: [
        { name: "Barbell Back Squat (below parallel)", sets: "4", reps: "6-8 @ RPE 8", rest: "3 min" },
        { name: "Hack Squat Machine (deep stretch)", sets: "3", reps: "10", rest: "2 min" },
        { name: "Bulgarian Split Squat (deep front knee flex)", sets: "3", reps: "10/leg", rest: "90 sec" },
        { name: "Leg Extension (pause at top)", sets: "3", reps: "12", rest: "60 sec" },
        { name: "Standing Calf Raise (full stretch at bottom)", sets: "4", reps: "12", rest: "45 sec" },
      ]},
      { day: "Day 4", title: "Shoulders + Arms", focus: "Lateral raise stretch + overhead triceps", exercises: [
        { name: "Seated Dumbbell Shoulder Press (below chin)", sets: "4", reps: "8 @ RPE 8", rest: "2 min" },
        { name: "Cable Lateral Raise (behind body, stretched)", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Rear Delt Fly Machine", sets: "3", reps: "15", rest: "45 sec" },
        { name: "Incline Dumbbell Curl", sets: "3", reps: "10", rest: "60 sec" },
        { name: "Overhead Rope Triceps Extension", sets: "3", reps: "12", rest: "60 sec" },
        { name: "Cable Hammer Curl", sets: "3", reps: "12", rest: "45 sec" },
      ]},
      { day: "Day 5", title: "Posterior Chain", focus: "Hamstring stretch + heavy hinge", exercises: [
        { name: "Deficit Deadlift", sets: "3", reps: "6", rest: "3 min" },
        { name: "Romanian Deadlift (long ROM)", sets: "3", reps: "10", rest: "2 min" },
        { name: "Seated Leg Curl (pause at full contraction)", sets: "4", reps: "12", rest: "60 sec" },
        { name: "Barbell Hip Thrust", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Back Extension (rounded to loaded stretch)", sets: "3", reps: "12", rest: "60 sec" },
      ]},
    ],
  }),
  ...
  buildProgram({
    ...
    category: "Fat Loss", level: "Intermediate", duration: "6 Weeks", daysPerWeek: 5, goal: "Visible recomp + GPP",
    image: programMetconCut,
    summary: "Three lift days plus two pure MetCon sessions - each finisher under 20 minutes, designed to spike heart rate without trashing the next session.",
    weeklySchedule: [
      { day: "Monday", session: "Upper Lift + MetCon" }, { day: "Tuesday", session: "Lower Lift + MetCon" }, { day: "Wednesday", session: "Rest / Walk" },
      { day: "Thursday", session: "Pure MetCon" }, { day: "Friday", session: "Full Body Lift" }, { day: "Saturday", session: "Pure MetCon" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Upper Lift + MetCon", focus: "Push/pull strength, then a 10-minute burner", exercises: [
      ...
      { day: "Day 2", title: "Lower Lift + MetCon", focus: "Squat + hinge, then a short bike burner", exercises: [
        { name: "- Strength -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Pure MetCon", focus: "EMOM 20 · one movement each minute, rest the remainder", exercises: [
        { name: "Kettlebell Swing", sets: "5", reps: "15", rest: "-" },
        { name: "Burpees", sets: "5", reps: "10", rest: "-" },
        { name: "Goblet Squat", sets: "5", reps: "15", rest: "-" },
        { name: "Push Ups", sets: "5", reps: "12", rest: "-" },
      ]},
      { day: "Day 5", title: "Full Body Lift", focus: "Compound circuit · muscle-protective volume", exercises: [
      ...
      { day: "Day 6", title: "Pure MetCon (Saturday)", focus: "For Time · sub-20 min chipper", exercises: [
        { name: "- 1 Round For Time -", sets: "", reps: "", rest: "" },
  ...
  buildProgram({
    ...
    category: "Women", level: "Beginner", duration: "10 Weeks", daysPerWeek: 4, goal: "Core + glute rebuild",
    image: programWomenPostpartum,
    summary: "Cleared-for-exercise mothers progress from breath work and pelvic floor activation into loaded hinging and squatting over ten weeks.",
    weeklySchedule: [
      { day: "Monday", session: "Core + Glutes (Light)" }, { day: "Tuesday", session: "Walk 30 min" }, { day: "Wednesday", session: "Lower Strength" },
      { day: "Thursday", session: "Rest" }, { day: "Friday", session: "Upper Strength" }, { day: "Saturday", session: "Full Body Light" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Core + Glutes (Light)", focus: "Reconnect pelvic floor, activate glutes", exercises: [
      ...
      { day: "Day 2", title: "Lower Strength", focus: "Loaded hinge + squat, still light", exercises: [
      ...
      { day: "Day 3", title: "Upper Strength", focus: "Back + shoulder posture rebuild", exercises: [
        { name: "Lat Pull Down", sets: "3", reps: "10", rest: "90 sec" },
        { name: "Seated Cable Row", sets: "3", reps: "10", rest: "90 sec" },
      ...
      { day: "Day 4", title: "Full Body Light + Core", focus: "Movement quality + core stability", exercises: [
  ...
  buildProgram({
    ...
    category: "Endurance", level: "Intermediate", duration: "6 Weeks", daysPerWeek: 4, goal: "Run a fast 3K",
    image: programRunning,
    summary: "Six weeks built around the 3K - VO2 max intervals, threshold work, and one weekly time trial so you learn exactly what 3K pace feels like.",
    weeklySchedule: [
      { day: "Monday", session: "VO2 Intervals (400s)" }, { day: "Tuesday", session: "Easy Run 30 min" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Threshold (1K reps)" }, { day: "Friday", session: "Rest" }, { day: "Saturday", session: "Time Trial / Long Run" }, { day: "Sunday", session: "Walk / Mobility" },
    ],
    workouts: [
      { day: "Day 1", title: "VO2 Intervals", focus: "400 m repeats", exercises: [
        { name: "Treadmill Run (Zone 5)", sets: "8", reps: "400 m", rest: "75 sec jog" },
      ]},
      { day: "Day 4", title: "Threshold", focus: "1K reps", exercises: [
        { name: "Treadmill Run (Zone 4)", sets: "4", reps: "1 km", rest: "2 min" },
      ]},
      { day: "Day 6", title: "3K Time Trial", focus: "Race pace", exercises: [
        { name: "Treadmill Run", sets: "1", reps: "3 km all-out", rest: "-" },
      ]},
    ],
  }),
  buildProgram({
    ...
    category: "Endurance", level: "Intermediate", duration: "8 Weeks", daysPerWeek: 4, goal: "Faster 5K",
    image: programRunning,
    summary: "Eight weeks of 5K-specific work: intervals, tempos, long runs and one weekly strength session to bulletproof the legs.",
    weeklySchedule: [
      { day: "Monday", session: "Strength for Runners" }, { day: "Tuesday", session: "Intervals (800s)" }, { day: "Wednesday", session: "Easy Run" },
      { day: "Thursday", session: "Tempo Run" }, { day: "Friday", session: "Rest" }, { day: "Saturday", session: "Long Run" }, { day: "Sunday", session: "Recovery Walk" },
    ],
    workouts: [
      { day: "Day 1", title: "Strength for Runners", focus: "Single-leg strength + calves to bulletproof the legs", exercises: [
        { name: "Goblet Squat", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Romanian Deadlift", sets: "3", reps: "8", rest: "90 sec" },
        { name: "Walking Lunge", sets: "3", reps: "12/side", rest: "60 sec" },
      ...
      { day: "Day 2", title: "Intervals", focus: "800 m repeats @ 5K pace", exercises: [
        { name: "Warm-Up Jog (Zone 2)", sets: "1", reps: "10 min easy", rest: "-" },
        { name: "Treadmill Run (Zone 5)", sets: "6", reps: "800 m @ 5K pace", rest: "2 min jog" },
        { name: "Cool-Down Jog", sets: "1", reps: "10 min easy", rest: "-" },
      ]},
      { day: "Day 3", title: "Easy Run", focus: "Zone 2 aerobic base", exercises: [
        { name: "Treadmill Run (Zone 2, conversational)", sets: "1", reps: "35-45 min", rest: "-" },
      ]},
      { day: "Day 4", title: "Tempo Run", focus: "Lactate threshold · comfortably hard", exercises: [
        { name: "Warm-Up Jog", sets: "1", reps: "10 min easy", rest: "-" },
        { name: "Treadmill Run (Zone 4)", sets: "1", reps: "20-25 min at threshold pace", rest: "-" },
        { name: "Cool-Down Jog", sets: "1", reps: "10 min easy", rest: "-" },
      ]},
      { day: "Day 6", title: "Long Run", focus: "Endurance base · builds 1-2 km per week", exercises: [
        { name: "Treadmill Run (Zone 2)", sets: "1", reps: "60-90 min at conversational pace", rest: "-" },
      ]},
    ],
  }),
  ...
  buildProgram({
    ...
    category: "Home Training", level: "Beginner", duration: "6 Weeks", daysPerWeek: 4, goal: "Lean muscle anywhere",
    image: programHomeDumbbell,
    summary: "Four short sessions a week using nothing but a single adjustable dumbbell pair. Every exercise pulled from the Onyx home library.",
    weeklySchedule: [
      { day: "Monday", session: "Upper Push" }, { day: "Tuesday", session: "Lower" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Upper Pull" }, { day: "Friday", session: "Full Body" }, { day: "Saturday", session: "Walk" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Upper Push", focus: "Chest, shoulders, triceps with one dumbbell pair", exercises: [
      ...
      { day: "Day 2", title: "Lower", focus: "Squat, hinge, unilateral quad/glute", exercises: [
      ...
      { day: "Day 3", title: "Upper Pull", focus: "Back and biceps · use a sturdy table for rows", exercises: [
      ...
      { day: "Day 4", title: "Full Body", focus: "Compound circuit · full-body pump", exercises: [
  ...
  buildProgram({
    ...
    category: "Home Training", level: "Beginner", duration: "8 Weeks", daysPerWeek: 4, goal: "Maintain on the road",
    image: programHomeBands,
    summary: "Designed for travel - every session uses only loop and tube bands. Anchor to a door, a sturdy post, or your own foot.",
    weeklySchedule: [
      { day: "Monday", session: "Push + Core" }, { day: "Tuesday", session: "Pull + Lower" }, { day: "Wednesday", session: "Rest" },
      { day: "Thursday", session: "Push + Core" }, { day: "Friday", session: "Full Body Circuit" }, { day: "Saturday", session: "Walk" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Push + Core", focus: "Anchor the band to a door for pressing", exercises: [
      ...
      { day: "Day 2", title: "Pull + Lower", focus: "Row from the door anchor + banded squats", exercises: [
      ...
      { day: "Day 4", title: "Push + Core (variation)", focus: "Slower tempo pressing, higher volume core", exercises: [
        { name: "Banded Push Ups (band across upper back)", sets: "4", reps: "12", rest: "60 sec" },
      ...
      { day: "Day 5", title: "Full Body Circuit", focus: "5 rounds · 45 sec on / 15 sec off per movement", exercises: [
  ...
  buildProgram({
    ...
    category: "Hyrox", level: "Intermediate", duration: "6 Weeks", daysPerWeek: 5, goal: "Hyrox doubles ready",
    image: programHyroxDoublesAsset.url,
    summary: "Compromised running, station handoffs, and pace rehearsal for the doubles format. Trains both partners independently and together.",
    weeklySchedule: [
      { day: "Monday", session: "Run + Sled" }, { day: "Tuesday", session: "Strength" }, { day: "Wednesday", session: "Row + Burpee" },
      { day: "Thursday", session: "Long Easy Run" }, { day: "Friday", session: "Handoff Sim" }, { day: "Saturday", session: "Mobility" }, { day: "Sunday", session: "Rest" },
    ],
    workouts: [
      { day: "Day 1", title: "Run + Sled (Doubles Style)", focus: "Partner A runs while Partner B pushes · 5 rounds", exercises: [
        { name: "- 5 Rounds · switch after each rep -", sets: "", reps: "", rest: "" },
        { name: "Treadmill Run (Partner A)", sets: "5", reps: "1 km", rest: "-" },
        { name: "Sled Push (Partner B, heavy)", sets: "5", reps: "50 m", rest: "60 sec (both rest before switching)" },
      ]},
      { day: "Day 2", title: "Strength", focus: "Lower + carry base · trained solo", exercises: [
      ...
      { day: "Day 3", title: "Row + Burpee (Doubles)", focus: "Partners alternate 250 m rows · 6 rounds", exercises: [
        { name: "- 6 Rounds ·  Partner A rows while Partner B burpees, then switch -", sets: "", reps: "", rest: "" },
        { name: "Rowing Machine (Partner A)", sets: "6", reps: "250 m all-out", rest: "-" },
        { name: "Burpee Broad Jump (Partner B)", sets: "6", reps: "10 while partner rows", rest: "60 sec (end of round)" },
      ]},
      { day: "Day 4", title: "Long Easy Run", focus: "Zone 2 aerobic base · run together at conversational pace", exercises: [
        { name: "Treadmill Run or Outdoor Run (Zone 2)", sets: "1", reps: "45-60 min", rest: "-" },
      ]},
      { day: "Day 5", title: "Handoff Sim (Race Rehearsal)", focus: "Doubles pacing · alternate every 100 reps or 50 m", exercises: [
  ...
  buildProgram({
    ...
    summary: "A four-day upper/lower rotation built on the 5/3/1 template. Each main lift waves through 5s, 3s and 1+ AMRAP weeks at a percentage of your Training Max, then deloads. Chest+shoulders share the pressing day, back+biceps share the pull day, and every session opens with a called RPE target so you never grind a bad day.",
    trainingOverview: "Four training days per week: Squat, Bench, Deadlift, Overhead Press each get their own main day. Weeks cycle 5s (RPE 7), 3s (RPE 8), 5/3/1+ AMRAP (RPE 9 on the top set), then deload. Assistance work stays in the 8-12 rep range at RPE 7-8 so recovery holds up.",
    progression: "Week 1: 65/75/85% x5 · Week 2: 70/80/90% x3 · Week 3: 75/85/95% x5/3/1+ AMRAP · Week 4 deload. Repeat the wave, add 2.5 kg (upper) / 5 kg (lower) to your Training Max each cycle. If the AMRAP set drops below the target, hold the TM the next cycle.",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Squat Day", focus: "Main squat + quad/glute accessories", exercises: [
        { name: "- Main lift (5/3/1 wave) -", sets: "", reps: "", rest: "" },
        { name: "Barbell Back Squat", sets: "3", reps: "5 → 3 → 1+ (RPE 7 → 8 → 9, Wk4 deload)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Smith Machine Reverse Lunge", sets: "3", reps: "10/leg @ RPE 8", rest: "90 sec" },
        { name: "Leg Press", sets: "3", reps: "10 @ RPE 8", rest: "90 sec" },
        { name: "Seated Leg Curl", sets: "3", reps: "12 @ RPE 8", rest: "60 sec" },
        { name: "Standing Calf Raise", sets: "4", reps: "12", rest: "45 sec" },
        { name: "Hanging Leg Raise", sets: "3", reps: "12", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Bench Day - Chest + Shoulders + Triceps", focus: "Main press + upper push", exercises: [
        { name: "- Main lift (5/3/1 wave) -", sets: "", reps: "", rest: "" },
        { name: "Barbell Bench Press", sets: "3", reps: "5 → 3 → 1+ (RPE 7 → 8 → 9, Wk4 deload)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 3", title: "Deadlift Day", focus: "Main pull + posterior chain", exercises: [
        { name: "- Main lift (5/3/1 wave) -", sets: "", reps: "", rest: "" },
        { name: "Barbell Deadlift", sets: "3", reps: "5 → 3 → 1+ (RPE 7 → 8 → 9, Wk4 deload)", rest: "3-4 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Overhead Day - Back + Biceps", focus: "Main overhead + pulling", exercises: [
        { name: "- Main lift (5/3/1 wave) -", sets: "", reps: "", rest: "" },
        { name: "Standing Overhead Press", sets: "3", reps: "5 → 3 → 1+ (RPE 7 → 8 → 9, Wk4 deload)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 5", title: "Optional Arms + Core Pump", focus: "Skip on deload week or if fatigued", exercises: [
  ...
  buildProgram({
    ...
    summary: "A 12-week upper/lower split with two heavy days and two volume days. Main lifts climb an RPE ladder every three weeks - RPE 7 → 8 → 9 → deload - so loads rise honestly without grinding. Chest+shoulders together on push days, back+biceps together on pull days, plus an optional weekend arms + core session.",
    trainingOverview: "Two heavy days (Upper Heavy, Lower Heavy) drive strength on the main lifts. Two volume days (Upper Volume, Lower Volume) drive hypertrophy with dumbbells, cables and machines. Every third week peaks intensity, then week 4 of each block is a deload.",
    progression: "3-week waves for 4 total blocks. Wave 1: RPE 7 (base). Wave 2: RPE 8 (build). Wave 3: RPE 9 top set + backoffs. Wave 4: deload week (60% loads, half the sets). Add 2.5 kg (upper) / 5 kg (lower) to the main lifts every completed wave.",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Upper Heavy - Chest + Shoulders + Triceps", focus: "Bench top set + pressing accessories", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Bench Press", sets: "4", reps: "5 (RPE 7 → 8 → 9, Wk4 deload)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 2", title: "Lower Heavy - Squat Focus", focus: "Squat top set + quad work", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Back Squat", sets: "4", reps: "5 (RPE 7 → 8 → 9, Wk4 deload)", rest: "3 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Smith Machine Reverse Lunge", sets: "3", reps: "10/leg @ RPE 8", rest: "90 sec" },
        { name: "Leg Press", sets: "3", reps: "10 @ RPE 8", rest: "90 sec" },
        { name: "Leg Extension", sets: "3", reps: "12", rest: "60 sec" },
      ...
      { day: "Day 3", title: "Upper Volume - Back + Biceps", focus: "Pump-focused pulling", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Bent Over Row", sets: "4", reps: "6 (RPE 7 → 8 → 9, Wk4 deload)", rest: "2 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Lower Volume - Hinge + Glutes", focus: "Deadlift top set + posterior chain", exercises: [
        { name: "- Main lift -", sets: "", reps: "", rest: "" },
        { name: "Barbell Deadlift", sets: "4", reps: "3 (RPE 7 → 8 → 9, Wk4 deload)", rest: "3-4 min" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 5", title: "Optional Arms + Core", focus: "Skip during deload week or if fatigued", exercises: [
        { name: "EZ Bar Curl", sets: "4", reps: "10 @ RPE 8", rest: "60 sec" },
...
const bodyweightHomePrograms: Program[] = [
  buildProgram({
    ...
    image: programBeginnerBodyweightAsset.url,
    summary: "Four 25-35 minute sessions using nothing but your own bodyweight and the floor. Push/pull-style split with a lower day and a full-body finisher. This one-week sampler grooves the movement pattern and stops every set 2-3 reps shy of failure.",
    progression: "Groove the pattern this week, stop 2-3 reps shy of failure on every set, and focus on tempo and full range of motion. If every set felt in control, add 1-2 reps per set next time you run the session. This is the on-ramp, the 8-Week Bodyweight Home Build takes over from here.",
    isFree: true,
    price: "Grátis",
    weeklySchedule: [
    ...
    workouts: [
      { day: "Day 1", title: "Upper Push + Core", focus: "Push patterns from the floor", exercises: [
        ...
        { name: "Bench Tricep Dips", sets: "3", reps: "10-12 (use a chair or couch edge)", rest: "60 sec" },
      ...
      { day: "Day 2", title: "Lower Body + Glutes", focus: "Squat, lunge, single-leg", exercises: [
        { name: "- Warm-up -", sets: "", reps: "", rest: "" },
        ...
        { name: "Alternating Bodyweight Reverse Lunges", sets: "3", reps: "10/leg", rest: "75 sec" },
        { name: "Bodyweight Bulgarian Squats", sets: "3", reps: "8-10/leg (rear foot on chair)", rest: "60 sec" },
        { name: "Single-Leg Bodyweight Glute Bridge", sets: "3", reps: "12/side (2-sec squeeze at top)", rest: "45 sec" },
        { name: "Standing Bodyweight Calve Raises", sets: "3", reps: "20", rest: "30 sec" },
      ]},
      { day: "Day 3", title: "Upper Pull + Core", focus: "Pulling patterns without a bar", exercises: [
        { name: "- Warm-up -", sets: "", reps: "", rest: "" },
      ...
      { day: "Day 4", title: "Full-Body Circuit", focus: "Conditioning + full-body strength", exercises: [
        { name: "- Circuit: 4 rounds, 45 sec work / 20 sec rest -", sets: "", reps: "", rest: "" },
        { name: "Bodyweight Squats", sets: "4", reps: "45 sec", rest: "20 sec" },
        { name: "Push Up On Toes", sets: "4", reps: "45 sec", rest: "20 sec" },
        { name: "Alternating Bodyweight Reverse Lunges", sets: "4", reps: "45 sec", rest: "20 sec" },
  ...
  buildProgram({
    ...
    tagline: "Zero equipment. Eight weeks. A real strength and conditioning block you can run anywhere.",
    category: "Home Training",
    level: "Beginner",
    duration: "8 Weeks",
    daysPerWeek: 5,
    ...
    image: programBeginnerBodyweightAsset.url,
    summary: "Five short sessions a week, Push, Lower, Pull, Full-Body Circuit and a Core + Conditioning finisher, built entirely from the Onyx bodyweight library. Loads rise honestly through added reps, slower tempos and harder push-up / squat variations rather than added weight.",
    trainingOverview: "Two strength-biased days (Upper Push, Lower Body) drive skill and strength on the hardest bodyweight patterns. Two volume days (Upper Pull + Core, Full-Body Circuit) drive hypertrophy and work capacity. A short Core + Conditioning finisher on day 5 caps the week without stealing recovery.",
    progression: "Weeks 1-3 · groove the pattern with 2-3 reps in reserve, add 1 rep per set as the week climbs. Week 4 · deload (cut every set to about 60% of your Week 3 reps, half effort). Weeks 5-7 · repeat the ramp with +2 reps per set vs Wave 1. Week 8 · deload + retest your max push-up and squat on the final session. Move up a harder variation (Push Up On Knees → On Toes → Diamond → Deficit) any time a set exceeds 15 clean reps.",
    weeklySchedule: [
      { day: "Monday", session: "Upper Push + Core" },
      { day: "Tuesday", session: "Lower Body + Glutes" },
    ...
    workouts: [
      { day: "Day 1", title: "Upper Push + Core", focus: "Push patterns · add reps as you get stronger", exercises: [
        { name: "- Warm-up -", sets: "", reps: "", rest: "" },
        { name: "Mountain Climbers", sets: "2", reps: "30 sec", rest: "30 sec" },
        { name: "Push Up On Knees", sets: "2", reps: "10 (primer)", rest: "30 sec" },
        { name: "- Main work -", sets: "", reps: "", rest: "" },
        { name: "Push Up On Toes", sets: "4", reps: "8-15 (stop 2 shy of failure)", rest: "90 sec" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Diamond Push Ups", sets: "3", reps: "6-10", rest: "75 sec" },
        { name: "Wide Push Ups", sets: "3", reps: "10-12", rest: "60 sec" },
        { name: "Advanced Tricep Bench Dips", sets: "3", reps: "10-12", rest: "60 sec" },
        { name: "Pike Push Ups", sets: "3", reps: "6-10 (feet elevated for overhead)", rest: "60 sec" },
        { name: "- Core finisher -", sets: "", reps: "", rest: "" },
        { name: "Plank", sets: "3", reps: "45-60 sec", rest: "45 sec" },
        { name: "Plank With Shoulder Tap", sets: "3", reps: "20 total taps", rest: "45 sec" },
      ]},
      { day: "Day 2", title: "Lower Body + Glutes", focus: "Squat + single-leg · add reps as you get stronger", exercises: [
        { name: "- Warm-up -", sets: "", reps: "", rest: "" },
        { name: "Bodyweight Squats", sets: "2", reps: "15 (slow tempo)", rest: "30 sec" },
        { name: "Banded Side Steps", sets: "2", reps: "15/side (bodyweight walk if no band)", rest: "30 sec" },
        { name: "- Main work -", sets: "", reps: "", rest: "" },
        { name: "Bodyweight Squats", sets: "4", reps: "15-25 (3-sec eccentric + 2-sec pause)", rest: "90 sec" },
        { name: "- Accessories -", sets: "", reps: "", rest: "" },
        { name: "Bodyweight Bulgarian Squats", sets: "3", reps: "8-12/leg", rest: "75 sec" },
        { name: "Alternating Bodyweight Reverse Lunges", sets: "3", reps: "10/leg", rest: "75 sec" },
        { name: "Step-Ups Bodyweight", sets: "3", reps: "10/leg (use a sturdy chair)", rest: "60 sec" },
        { name: "Single-Leg Bodyweight Glute Bridge", sets: "3", reps: "12/side (2-sec squeeze at top)", rest: "45 sec" },
        { name: "Standing Bodyweight Calve Raises", sets: "4", reps: "20", rest: "30 sec" },
      ]},
      { day: "Day 3", title: "Upper Pull + Core", focus: "Pulling patterns without a bar + midline", exercises: [
        { name: "- Warm-up -", sets: "", reps: "", rest: "" },
        ...
        { name: "Bird Dog", sets: "3", reps: "10/side (2-sec pause at extension)", rest: "45 sec" },
        { name: "- Core finisher -", sets: "", reps: "", rest: "" },
        { name: "Reverse Crunch", sets: "3", reps: "12-15", rest: "45 sec" },
        { name: "Side Plank", sets: "3", reps: "30-45 sec/side", rest: "30 sec" },
      ]},
      { day: "Day 4", title: "Full-Body Circuit", focus: "Density + conditioning", exercises: [
        { name: "- Circuit: 5 rounds, 40 sec work / 20 sec rest, 90 sec between rounds -", sets: "", reps: "", rest: "" },
        { name: "Bodyweight Squats", sets: "5", reps: "40 sec (steady tempo)", rest: "20 sec" },
        { name: "Push Up On Toes", sets: "5", reps: "40 sec (drop to knees to keep the tempo)", rest: "20 sec" },
        { name: "Alternating Bodyweight Reverse Lunges", sets: "5", reps: "40 sec", rest: "20 sec" },
        { name: "Mountain Climbers", sets: "5", reps: "40 sec", rest: "20 sec" },
        { name: "Leg Raise Hip Lift", sets: "5", reps: "12", rest: "90 sec between rounds" },
      ]},
      { day: "Day 5", title: "Core + Conditioning Finisher", focus: "Short, sharp cap on the week, skip on deload weeks (4 & 8)", exercises: [
        ...
        { name: "Bodyweight Squats", sets: "5", reps: "15 reps on the minute", rest: "rest of minute" },
      ]},
    ],
  }),
];
