...
export const quickWorkouts: QuickWorkout[] = [
  {
    ...
    intro:
      "Twenty explosive minutes. Deep core bracing paired with burpees between every set to keep the heart rate high. Simple, hard, effective.",
    equipment: "Mat only",
    ...
    blocks: [
      ...
      {
        title: "Core + burpees circuit",
        minutes: 12,
        note: "3 rounds, one core exercise, then 10 burpees. Rest between every move.",
        exercises: [
          {
          ...
          { slug: "burpees", name: "Burpees", sets: "3", reps: "10", rest: "45s" },
          {
            slug: "bicycle-crunches-hard",
            name: "Bicycle Crunches Hard",
            sets: "3",
            reps: "20 total",
            rest: "30s",
          },
      ...
      },
      {
        title: "Core finisher",
        minutes: 5,
        note: "AMRAP 5 minutes, rest 15s between exercises, then repeat.",
        exercises: [
  ...
  },
  {
    ...
    intro:
      "Five minutes, mat only, pure core. No burpees, no fluff, just back-to-back ab work. Perfect finisher after any session.",
    equipment: "Mat only",
    image: "/__l5e/assets-v1/9eed9ea9-3d27-4dd8-bf42-75199cc15e5b/core-burn.png",
    blocks: [
      {
        title: "5 minute core circuit",
        minutes: 5,
        note: "3 rounds, 30 seconds work, 15 seconds rest between each exercise.",
        exercises: [
          ...
          {
            slug: "weighted-russian-twists-easy",
            name: "Russian Twists",
            sets: "3",
            reps: "30s",
            rest: "20s",
  ...
  },
  {
    ...
    intro:
      "Forty minutes of pure chest work with full gym equipment. Heavy compound press, incline hypertrophy, and a cable-fly burnout.",
    ...
    blocks: [
      {
        ...
        exercises: [
          { slug: "push-ups", name: "Push Ups", sets: "2", reps: "10", rest: "45s" },
          {
            ...
            reps: "5",
            rest: "60s",
            note: "Empty bar → ramp up to working weight.",
          },
        ],
      },
      {
        title: "Main press",
        minutes: 22,
        note: "Heavy compound work. Rest fully between top sets.",
        exercises: [
          {
            slug: "barbell-bench-press",
            name: "Barbell Bench Press",
          ...
          {
            slug: "incline-dumbbell-chest-press",
      ...
      },
      {
        ...
        minutes: 13,
        note: "Superset, 3 rounds, rest 60s between rounds.",
        exercises: [
          {
            slug: "high-cable-chest-flys",
  ...
  },
  {
    ...
    intro:
      "Complete back day at the gym. One heavy hinge, vertical pull, horizontal pull, and rear delts. Everything a strong back needs in 40 minutes.",
    ...
    blocks: [
      {
        ...
        exercises: [
          {
            slug: "standing-cable-face-pulls",
      ...
      },
      {
        title: "Main lifts",
        minutes: 25,
        note: "Rest 2 min between heavy sets.",
        exercises: [
          {
          ...
          {
            slug: "seated-dual-handle-cable-row",
      ...
      },
      {
        ...
        minutes: 10,
        note: "Superset, 3 rounds, rest 45s between rounds.",
        exercises: [
          {
            slug: "standing-cable-face-pulls",
            name: "Standing Cable Face Pulls",
  ...
  },
  {
    ...
    intro:
      "Build round, capped shoulders. Heavy overhead press first, then all three delt heads with lateral raises, front raises, and face pulls.",
    ...
    blocks: [
      ...
      },
      {
        title: "Main press",
        minutes: 22,
        note: "Rest 90 sec to 2 minutes between working sets.",
        exercises: [
          {
      ...
      },
      {
        title: "Delt burnout",
        minutes: 13,
        note: "Giant set, 3 rounds, rest 60s between rounds.",
        exercises: [
          {
          ...
          {
            slug: "single-arm-cable-side-raise",
  ...
  },
  {
    ...
    intro:
      "Full leg day at the gym in 40 minutes. Heavy squat, hinge for hamstrings, glute thrusts, and a brutal calf finisher.",
    ...
    blocks: [
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            reps: "5",
            rest: "60s",
            note: "Ramp up to working weight.",
          },
        ],
      },
      {
        title: "Main lifts",
        minutes: 22,
        note: "Rest 2 min between top sets.",
        exercises: [
          { slug: "barbell-squat", name: "Barbell Squat", sets: "4", reps: "6", rest: "2 min" },
          {
            slug: "barbell-stiff-leg-deadlifts",
      ...
      },
      {
        title: "Glutes + calves",
        minutes: 13,
        note: "3 rounds, rest 45s between exercises.",
        exercises: [
          {
            slug: "barbell-glute-hip-thrusts",
          ...
          {
            slug: "smith-machine-calve-raises",
  ...
  },
  {
    ...
    intro:
      "Round out your shoulders at home with just a pair of dumbbells. Press, raise all three delt heads, and finish with a shoulder-tap burnout.",
    ...
    blocks: [
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            slug: "dumbbell-bent-over-rear-delt-fly",
      ...
      },
      {
        title: "Finisher",
        minutes: 6,
        note: "AMRAP 5 minutes, rest 20s between exercises.",
        exercises: [
          {
            slug: "plank-shoulder-taps",
            name: "Plank Shoulder Taps",
  ...
  },
  {
    ...
    intro:
      "Torch your legs at home. Squats, lunges, hip thrusts and a jump-squat finisher. Dumbbells help but bodyweight works.",
    ...
    blocks: [
      ...
      },
      {
        ...
        exercises: [
          {
            slug: "bodyweight-bulgarian-squats",
          ...
          {
            slug: "alternating-bodyweight-reverse-lunges",
          ...
          {
            slug: "single-leg-body-weight-glute-hip-thrusts",
            name: "Single-Leg Glute Hip Thrust",
            sets: "3",
            reps: "12/side",
            rest: "45s",
          },
          {
            slug: "standing-bodyweight-calve-raises",
      ...
      },
      {
        ...
        minutes: 7,
        note: "AMRAP 6 minutes, rest 30s between exercises.",
        exercises: [
          {
            slug: "box-jumps",
            name: "Box Jumps",
  ...
  },
  {
    ...
    intro:
      "Full race-day feel. Sled push, rower, kettlebell swings and box jumps in a big engine circuit. Distances are in meters, row 500 m means row until the machine display reads 500 meters. Bring water.",
    ...
    blocks: [
      ...
      },
      {
        ...
        minutes: 30,
        note: "Work through the stations in order, top to bottom, one time only. Rest as noted between stations. Distances are meters, row 500 m means row until the screen reads 500 meters, sled 20 m means push the sled 20 meters down the floor and walk back.",
        exercises: [
          {
            slug: "rowing-machine",
            name: "Rowing Machine",
            ...
            reps: "500 m",
            rest: "60s",
            note: "Steady, hard pace. Row until the screen shows 500 meters.",
          },
          {
            slug: "sled-push",
            name: "Sled Push",
            ...
            reps: "20 m",
            rest: "45s",
            note: "Push 20 meters, walk back, rest, repeat 3 times.",
          },
          { slug: "burpees", name: "Burpees", sets: "1", reps: "15 reps", rest: "45s" },
          {
            ...
            reps: "500 m",
            rest: "60s",
            note: "Second row. Same pace if you can hold it.",
          },
          {
            ...
            reps: "15 reps",
            rest: "30s",
            note: "3 sets of 15, rest 30s between.",
          },
  ...
  },
  {
    ...
    intro:
      "Full arm day with the whole gym. Heavy barbell curls, preacher curls and cable pushdowns for a real pump.",
    ...
    blocks: [
        ...
        exercises: [
          {
            ...
            reps: "12",
            rest: "30s",
            note: "Bodyweight, warm the elbow.",
          },
          {
      ...
      },
      {
        ...
        minutes: 25,
        note: "Alternate biceps and triceps, rest 60-90s between working sets.",
        exercises: [
          { slug: "barbell-curls", name: "Barbell Curls", sets: "4", reps: "8-10", rest: "90s" },
          {
            slug: "cable-rope-tricep-pressdown",
          ...
          {
            slug: "cable-rope-overhead-tricep-extensions",
      ...
      {
        title: "Arm pump finisher",
        minutes: 10,
        note: "Superset, 3 rounds, rest 45s between rounds.",
        exercises: [
          {
            slug: "incline-alternating-hammer-curls",
          ...
          {
            slug: "dumbbell-tricep-kickbacks",
