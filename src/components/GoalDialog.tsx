    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="container-onyx relative py-16 md:py-24">
          ...
          <h1 className="mt-4 font-display text-4xl md:text-6xl font-bold leading-[1.02] max-w-3xl">
            {g.title}
          </h1>
      ...
      <div className="container-onyx py-12 md:py-16 space-y-14 min-w-0">
        ...
        <section>
          ...
          <h2 className="mt-2 font-display text-2xl md:text-4xl font-bold">
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        ref={contentRef}
        data-goal-scroller
        className="block w-full sm:w-[calc(100%-1rem)] max-w-full sm:max-w-5xl h-[100dvh] sm:h-auto max-h-[100dvh] sm:max-h-[92dvh] overflow-y-auto overscroll-contain p-0 bg-onyx-50 border-border/60 rounded-none sm:rounded-2xl [-webkit-overflow-scrolling:touch] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]"
      >
        <VisuallyHidden>
        ...
        <div className="sticky top-0 right-0 z-50 h-0 pointer-events-none">
          <DialogClose className="absolute right-3 top-[max(env(safe-area-inset-top),0.75rem)] pointer-events-auto grid h-9 w-9 place-items-center rounded-full bg-onyx-950/70 text-white backdrop-blur-md ring-1 ring-white/20 hover:bg-onyx-950/90 transition-colors focus:outline-none focus:ring-2 focus:ring-electric">
            <X className="h-4 w-4" />
