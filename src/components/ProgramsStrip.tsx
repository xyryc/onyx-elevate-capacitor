...
const muscleBuildingWeek1: Day[] = [
  ...
  },
  {
    day: "Day 7",
    title: "Rest",
    focus: "Full rest or 20 min walk",
    exercises: [{ name: "Treadmill Walking", sets: "1", reps: "Optional 20 min", rest: "-" }],
  },
];
...
const lowerBodyWeek1: Day[] = [
  ...
  },
  {
    ...
    focus: "Keep pressing & pulling sharp",
    exercises: [
    ...
    >
          ...
          <div className="min-w-0 w-full">
            <div className="flex flex-wrap gap-1.5 text-[10px] uppercase tracking-wider">
              <span className="px-2 py-1 rounded-md bg-electric text-onyx-50 font-bold">
                {unlocked ? "Unlocked · Premium" : "Premium · Onyx Program"}
              </span>
            ...
            <DialogHeader className="space-y-1 mt-2 sm:mt-3 text-left">
              <DialogTitle className="font-display text-xl sm:text-2xl md:text-4xl font-bold leading-tight break-words">
                {title}
              </DialogTitle>
              <DialogDescription className="text-xs sm:text-sm text-muted-foreground max-w-2xl line-clamp-3 sm:line-clamp-none">
                {subtitle}
              </DialogDescription>
            </DialogHeader>
          </div>
      ...
      <div className="px-4 sm:px-6 md:px-8 pb-6 sm:pb-8 pt-5 sm:pt-6 space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
          {[
            ...
            <div key={s.label} className="surface-card rounded-xl p-3 sm:p-4">
              <p className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-semibold">
                {s.label}
              </p>
              <p className="mt-1 font-display text-sm sm:text-base font-bold leading-tight">
                {s.value}
              </p>
            </div>
          ))}
        ...
        <section>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-3 sm:gap-4">
            <div className="surface-card rounded-xl p-4 sm:p-5">
              <p className="text-[10px] uppercase tracking-[0.2em] text-electric font-semibold mb-2.5">
                Who it's for
              </p>
              <ul className="space-y-2">
                {meta.whoFor.map((x) => (
                  <li key={x} className="flex gap-2 text-sm text-foreground/85">
                    <svg
                      className="h-4 w-4 text-electric shrink-0 mt-0.5"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
        ...
        <section className="surface-card rounded-xl p-4 sm:p-5">
          <p className="text-[10px] uppercase tracking-[0.25em] text-electric font-bold">
            {lengthLabel} · Progression
          </p>
          <h3 className="mt-1.5 font-display text-lg sm:text-xl font-bold leading-tight">
        ...
        {/* Warm-up */}
        <section className="surface-card rounded-xl p-4 sm:p-5">
          <p className="text-[10px] uppercase tracking-[0.2em] text-electric font-semibold mb-2">
            Warm-up · every session
          </p>
          <p className="text-sm text-foreground/85">
            5 min light cardio · 2 rounds of band pull-aparts, hip openers, scap push-ups · ramp the
            first big lift in 3-4 progressive sets.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {unlocked
              ? "Every week is included with your Onyx membership. Open the app to start training."
              : "Week 1 is free to preview. Unlock the rest with Onyx Pro or the All Access bundle."}
          </p>
        </section>
        ...
        {locked ? (
          <div className="rounded-xl border border-dashed border-electric/40 bg-onyx-100/40 p-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
              Unlock weeks 2-{totalWeeks} with Onyx Pro or the All Access bundle, video for every
              exercise, RPE targets, wave-loaded progression, streak tracking and PR logging.
            </p>
            <Link
              to="/app"
              className="mt-5 inline-flex items-center rounded-md bg-electric px-6 py-2.5 text-sm font-bold text-onyx-50 hover:bg-electric-glow"
            >
          ...
          <div className="rounded-xl border border-electric/40 bg-onyx-100/40 p-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
              Open the Onyx app to start Week {week}, day-by-day workouts, videos and progression
              are all synced to your account.
            </p>
            <Link
              to="/app"
              className="mt-5 inline-flex items-center rounded-md bg-electric px-6 py-2.5 text-sm font-bold text-onyx-50 hover:bg-electric-glow"
        ...
        <div className="rounded-2xl border border-electric/40 bg-gradient-to-br from-onyx-100/60 to-onyx-50 p-6 text-center">
          <h3 className="font-display text-xl font-bold">
            Unlock the full program inside the Onyx app
          </h3>
          <p className="mt-2 text-sm text-muted-foreground">
            Week-by-week progressions, video for every exercise, streak tracking and PR logging.
          </p>
          <div className="mt-4 flex flex-wrap justify-center gap-3">
            <Link
              to="/programs"
              className="inline-flex items-center rounded-md bg-electric px-5 py-2.5 text-sm font-bold text-onyx-50 hover:bg-electric-glow"
            >
              Browse all programs
            </Link>
            <Link
              to="/app"
              className="inline-flex items-center rounded-md border border-border bg-onyx-100/60 px-5 py-2.5 text-sm font-semibold hover:bg-onyx-200"
            >
              Get the Onyx app
            </Link>
          </div>
      ...
      <div className="-mx-4 px-4 flex gap-4 overflow-x-auto snap-x snap-mandatory md:mx-0 md:px-0 md:grid md:gap-5 md:grid-cols-3 md:overflow-visible scrollbar-none [&>*]:shrink-0 [&>*]:snap-start [&>*]:w-[82%] md:[&>*]:w-auto md:[&>*]:shrink">
        ...
        <Dialog>
            ...
            <article className="surface-card rounded-xl overflow-hidden group hover:border-electric/40 transition-all text-left cursor-pointer">
              ...
              <div className="p-5">
                <h3 className="font-display text-lg font-semibold">
                  {t("12 Week Muscle Building")}
                </h3>
                <p className="mt-1.5 text-sm text-muted-foreground">
                  {t("Progressive hypertrophy plan engineered to add visible muscle.")}
                </p>
          ...
          <ProgramPreviewDialog
            ...
            subtitle={t(
              "A six-day upper/lower hybrid built for steady, visible hypertrophy. Wave-loaded so weeks never repeat.",
            )}
            image={programMuscle}
            ...
            meta={{
              ...
              overview: t(
                "A 12-week upper/lower hybrid split that alternates strength and pump work. You'll press, pull, squat and hinge twice per week with wave-loaded intensity so each block pushes past the last, engineered for steady, visible muscle gain without burning out.",
              ),
              whoFor: [
              ...
              progression: t(
                "Weeks 1-4 build volume at moderate intensity. Weeks 5-8 push heavier compounds while trimming assistance volume. Weeks 9-12 peak intensity with a light deload before the final wave, so you finish stronger and bigger than you started.",
              ),
            }}
          />
        </Dialog>
        ...
        <Link
          to="/app"
          className="surface-card rounded-xl overflow-hidden group hover:border-electric/40 transition-all block"
        >
          <div className="aspect-[16/10] overflow-hidden">
            <img
              src={programBeginner}
              alt={t("Beginner Strength")}
              loading="lazy"
              className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
            />
          </div>
          <div className="p-5">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              {t("Master the big lifts with linear progression and zero guesswork.")}
            </p>
            <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-electric group-hover:text-electric-glow">
              {t("Download in App")}
              <svg
        ...
        <Dialog>
          <DialogTrigger asChild>
            <article className="surface-card rounded-xl overflow-hidden group hover:border-electric/40 transition-all text-left cursor-pointer">
              <div className="relative aspect-[16/10] overflow-hidden">
                <img
                  src={programLower}
                  alt={t("Lower Body Specialization")}
                  loading="lazy"
                  className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
                />
                <span className="absolute top-2 left-2 rounded-md bg-electric text-onyx-50 text-[10px] uppercase tracking-wider px-2 py-1 font-bold shadow-lg">
              ...
              <div className="p-5">
                <h3 className="font-display text-lg font-semibold">
                  {t("Lower Body Specialization")}
                </h3>
                <p className="mt-1.5 text-sm text-muted-foreground">
                  {t("An 8-week block to bring up lagging legs and glutes.")}
                </p>
                <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-electric group-hover:text-electric-glow">
                  {t("See what's inside")}
                  <svg
          ...
          <ProgramPreviewDialog
            ...
            subtitle={t(
              "8-week leg & glute focus with maintained upper-body work. Two pulling waves drive serious posterior development.",
            )}
            image={programLower}
            ...
            meta={{
              ...
              daysPerWeek: t("6 days / wk"),
              overview: t(
                "An 8-week specialization block that puts legs and glutes at the front of every week. Squat and hinge patterns run twice on heavy days, with a dedicated glute/hamstring session and quad hypertrophy day, while upper-body work is trimmed to just enough to maintain strength.",
              ),
              whoFor: [
              ...
              progression: t(
                "Weeks 1-3 accumulate volume on squat and hinge patterns. Weeks 4-6 shift toward heavier top sets on the main lifts while adding intensifiers on isolation work. Weeks 7-8 peak posterior-chain strength and finish with a pump-focused hypertrophy wave.",
              ),
            }}
          />
        </Dialog>
